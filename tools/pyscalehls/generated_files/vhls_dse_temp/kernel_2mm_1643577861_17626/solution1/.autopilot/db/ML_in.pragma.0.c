...
#pragma HLS ARRAY_PARTITION variable=&v4 block factor=16 dim=2
# 21 "../ML_in.c"

#pragma HLS ARRAY_PARTITION variable=&v4 block factor=4 dim=1
# 21 "../ML_in.c"

#pragma HLS ARRAY_PARTITION variable=&v5 cyclic factor=64 dim=1
# 21 "../ML_in.c"
