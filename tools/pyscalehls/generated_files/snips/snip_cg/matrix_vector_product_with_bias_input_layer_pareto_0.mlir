func @matrix_vector_product_with_bias_input_layer(%arg0: memref<64xf64>, %arg1: memref<832xf64, affine_map<(d0) -> (d0 mod 104, d0 floordiv 104)>, 1>, %arg2: memref<64xf64, affine_map<(d0) -> (d0 mod 8, d0 floordiv 8)>, 1>, %arg3: memref<13xf64, affine_map<(d0) -> (d0 mod 13, d0 floordiv 13)>, 1>) attributes {func_directive = #hlscpp.fd<pipeline=false, targetInterval=1, dataflow=false, topFunc=true>, llvm.linkage = #llvm.linkage<external>, resource = #hlscpp.r<lut=0, dsp=65, bram=0>, timing = #hlscpp.t<0 -> 132, 132, 132>} {
  ...
  } {loop_directive = #hlscpp.ld<pipeline=true, targetII=8, dataflow=false, flatten=false, parallel=true>, loop_info = #hlscpp.l<flattenTripCount=8, iterLatency=72, minII=8>, timing = #hlscpp.t<0 -> 130, 130, 130>}
  return {timing = #hlscpp.t<130 -> 130, 0, 0>}
}
