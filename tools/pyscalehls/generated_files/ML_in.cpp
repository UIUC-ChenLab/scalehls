...
void SgdLR_sw(
  ...
  loop0: for (int v4 = 0; v4 < 5; v4 += 1) {	// L6, [0,11430012), iterCycle=2286002, II=2286002
    loop1: for (int v5 = 0; v5 < 4500; v5 += 1) {	// L7, [0,2286002), iterCycle=508, II=508
      float v6[1];	// L8, [0,0)
      v6[0] = 0.000000;	// L9, [0,1)
      float v7[1];	// L10, [0,0)
      v7[0] = 0.000000;	// L11, [0,1)
      loop2: for (int v8 = 0; v8 < 32; v8 += 1) {	// L12, [1,387), iterCycle=167, II=7
#pragma HLS pipeline
      ...
      loop3: for (int v143 = 0; v143 < 32; v143 += 1) {	// L150, [418,463), iterCycle=12, II=1
#pragma HLS pipeline
        int v144 = v1[v5];	// L151, [0,2)
      ...
      loop4: for (int v211 = 0; v211 < 32; v211 += 1) {	// L251, [463,508), iterCycle=12, II=1
#pragma HLS pipeline
