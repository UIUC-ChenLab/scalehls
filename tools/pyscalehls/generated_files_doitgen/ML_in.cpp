...
void kernel_doitgen(
  ...
  loop0: for (int v6 = 0; v6 < 25; v6 += 1) {	// L3, [0,102552), iterCycle=4102, II=4102
    loop1: for (int v7 = 0; v7 < 20; v7 += 1) {	// L4, [0,4102), iterCycle=205, II=205
      loop2: for (int v8 = 0; v8 < 5; v8 += 1) {	// L5, [0,171), iterCycle=37, II=33
#pragma HLS pipeline
      ...
      loop3: for (int v615 = 0; v615 < 2; v615 += 1) {	// L763, [171,205), iterCycle=17, II=15
#pragma HLS pipeline
