...
#pragma HLS ARRAY_PARTITION variable=&biases1 block factor=64 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&biases2 cyclic factor=4 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&biases3 complete dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&training_data block factor=163 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&training_targets cyclic factor=3 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&weights1 cyclic factor=13 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&weights3 cyclic factor=3 dim=1
# 550 "../ML_in.cpp"

    int i,j;

    double activations1[64];
#pragma HLS ARRAY_PARTITION variable=&activations1 complete dim=1
# 553 "../ML_in.cpp"

    double activations2[64];
#pragma HLS ARRAY_PARTITION variable=&activations2 complete dim=1
# 554 "../ML_in.cpp"
...
#pragma HLS ARRAY_PARTITION variable=&dactivations1 cyclic factor=64 dim=1
# 556 "../ML_in.cpp"
...
#pragma HLS ARRAY_PARTITION variable=&delta_weights1 cyclic factor=26 dim=1
# 562 "../ML_in.cpp"
