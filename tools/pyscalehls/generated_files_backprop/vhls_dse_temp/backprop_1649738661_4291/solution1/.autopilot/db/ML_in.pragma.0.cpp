...
#pragma HLS ARRAY_PARTITION variable=&biases1 complete dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&biases2 complete dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&weights1 block factor=8 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&weights2 cyclic factor=64 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&weights3 block factor=6 dim=1
# 550 "../ML_in.cpp"
...
#pragma HLS ARRAY_PARTITION variable=&dactivations2 block factor=64 dim=1
# 557 "../ML_in.cpp"
...
#pragma HLS ARRAY_PARTITION variable=&delta_weights2 block factor=64 dim=1
# 563 "../ML_in.cpp"
...
#pragma HLS ARRAY_PARTITION variable=&oracle_activations2 cyclic factor=8 dim=1
# 566 "../ML_in.cpp"
