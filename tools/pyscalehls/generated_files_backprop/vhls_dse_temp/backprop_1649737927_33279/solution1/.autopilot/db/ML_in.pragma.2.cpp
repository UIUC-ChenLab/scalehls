...
_ssdm_SpecArrayPartition( biases1, 1, "CYCLIC", 16, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( biases2, 1, "BLOCK", 4, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( biases3, 1, "BLOCK", 3, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( training_data, 1, "BLOCK", 13, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( training_targets, 1, "CYCLIC", 3, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( weights2, 1, "CYCLIC", 8, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( weights3, 1, "CYCLIC", 16, "");
# 550 "../ML_in.cpp"
...
_ssdm_SpecArrayPartition( activations2, 1, "BLOCK", 2, "");
# 554 "../ML_in.cpp"

    double activations3[3];
_ssdm_SpecArrayPartition( activations3, 1, "BLOCK", 3, "");
# 555 "../ML_in.cpp"

    double dactivations1[64];
_ssdm_SpecArrayPartition( dactivations1, 1, "BLOCK", 64, "");
# 556 "../ML_in.cpp"

    double dactivations2[64];
_ssdm_SpecArrayPartition( dactivations2, 1, "COMPLETE", 0, "");
# 557 "../ML_in.cpp"

    double dactivations3[3];
_ssdm_SpecArrayPartition( dactivations3, 1, "BLOCK", 3, "");
# 558 "../ML_in.cpp"

    double net_outputs[3];
_ssdm_SpecArrayPartition( net_outputs, 1, "COMPLETE", 0, "");
# 559 "../ML_in.cpp"
...
_ssdm_SpecArrayPartition( delta_weights2, 1, "BLOCK", 256, "");
# 563 "../ML_in.cpp"

    double delta_weights3[64*3];
    double oracle_activations1[64];
_ssdm_SpecArrayPartition( oracle_activations1, 1, "BLOCK", 8, "");
# 565 "../ML_in.cpp"
