...
#pragma HLS ARRAY_PARTITION variable=&biases1 block factor=2 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&biases2 block factor=32 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&biases3 cyclic factor=3 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&training_data cyclic factor=163 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&training_targets cyclic factor=163 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&weights1 cyclic factor=104 dim=1
# 550 "../ML_in.cpp"

#pragma HLS ARRAY_PARTITION variable=&weights2 block factor=32 dim=1
# 550 "../ML_in.cpp"
...
#pragma HLS ARRAY_PARTITION variable=&dactivations2 block factor=2 dim=1
# 557 "../ML_in.cpp"

    double dactivations3[3];
#pragma HLS ARRAY_PARTITION variable=&dactivations3 complete dim=1
# 558 "../ML_in.cpp"
...
#pragma HLS ARRAY_PARTITION variable=&delta_weights2 block factor=2 dim=1
# 563 "../ML_in.cpp"

    double delta_weights3[64*3];
    double oracle_activations1[64];
#pragma HLS ARRAY_PARTITION variable=&oracle_activations1 complete dim=1
# 565 "../ML_in.cpp"

    double oracle_activations2[64];
#pragma HLS ARRAY_PARTITION variable=&oracle_activations2 cyclic factor=2 dim=1
# 566 "../ML_in.cpp"
