...
_ssdm_SpecArrayPartition( biases1, 1, "BLOCK", 2, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( biases2, 1, "BLOCK", 32, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( biases3, 1, "CYCLIC", 3, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( training_data, 1, "CYCLIC", 163, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( training_targets, 1, "CYCLIC", 163, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( weights1, 1, "CYCLIC", 104, "");
# 550 "../ML_in.cpp"

_ssdm_SpecArrayPartition( weights2, 1, "BLOCK", 32, "");
# 550 "../ML_in.cpp"

    int i,j;

    double activations1[64];
_ssdm_SpecArrayPartition( activations1, 1, "CYCLIC", 2, "");
# 553 "../ML_in.cpp"

    double activations2[64];
_ssdm_SpecArrayPartition( activations2, 1, "CYCLIC", 8, "");
# 554 "../ML_in.cpp"

    double activations3[3];
_ssdm_SpecArrayPartition( activations3, 1, "CYCLIC", 3, "");
# 555 "../ML_in.cpp"

    double dactivations1[64];
_ssdm_SpecArrayPartition( dactivations1, 1, "CYCLIC", 8, "");
# 556 "../ML_in.cpp"

    double dactivations2[64];
_ssdm_SpecArrayPartition( dactivations2, 1, "BLOCK", 2, "");
# 557 "../ML_in.cpp"

    double dactivations3[3];
_ssdm_SpecArrayPartition( dactivations3, 1, "COMPLETE", 0, "");
# 558 "../ML_in.cpp"
...
_ssdm_SpecArrayPartition( delta_weights2, 1, "BLOCK", 2, "");
# 563 "../ML_in.cpp"

    double delta_weights3[64*3];
    double oracle_activations1[64];
_ssdm_SpecArrayPartition( oracle_activations1, 1, "COMPLETE", 0, "");
# 565 "../ML_in.cpp"

    double oracle_activations2[64];
_ssdm_SpecArrayPartition( oracle_activations2, 1, "CYCLIC", 2, "");
# 566 "../ML_in.cpp"
