          ...
          for (auto inductionVar : inductionVars) {
            if (val == inductionVar) {
              if (nestedLoops[idx].hasConstantUpperBound()) {
                ...
                auto ifExpr = getAffineDimExpr(0, module.getContext()) -
                              getAffineDimExpr(1, module.getContext()) -
                              getAffineConstantExpr(1, module.getContext());
                auto ifCondition =
