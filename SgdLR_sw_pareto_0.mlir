func @SgdLR_sw(%arg0: memref<4608000xf32, affine_map<(d0) -> (d0 mod 32, d0 floordiv 32)>, 1>, %arg1: memref<4500xi32, affine_map<(d0) -> (0, d0)>, 1>, %arg2: memref<1024xf32, affine_map<(d0) -> (d0 mod 32, d0 floordiv 32)>, 1>) attributes {func_directive = #hlscpp.fd<pipeline=false, targetInterval=1, dataflow=false, topFunc=true>, llvm.linkage = #llvm.linkage<external>, resource = #hlscpp.r<lut=0, dsp=167, bram=32>, timing = #hlscpp.t<0 -> 11430014, 11430014, 11430014>} {
  ...
  %cst_0 = arith.constant {timing = #hlscpp.t<0 -> 0, 0, 0>} 1.000000e+00 : f32
  %cst_1 = arith.constant {timing = #hlscpp.t<0 -> 0, 0, 0>} 0.000000e+00 : f32
  ...
  affine.for %arg3 = 0 to 5 {
    affine.for %arg4 = 0 to 4500 {
      ...
      affine.store %cst_1, %1[0] {partition_indices = [0], timing = #hlscpp.t<0 -> 1, 1, 1>} : memref<1xf32, affine_map<(d0) -> (0, d0)>, 1>
      %2 = memref.alloc() {timing = #hlscpp.t<0 -> 0, 0, 0>} : memref<1xf32, affine_map<(d0) -> (0, d0)>, 1>
      affine.store %cst_1, %2[0] {partition_indices = [0], timing = #hlscpp.t<0 -> 1, 1, 1>} : memref<1xf32, affine_map<(d0) -> (0, d0)>, 1>
      ...
      %6 = arith.addf %5, %cst_0 {timing = #hlscpp.t<397 -> 402, 5, 1>} : f32
      %7 = arith.divf %cst_0, %6 {timing = #hlscpp.t<402 -> 418, 16, 1>} : f32
      affine.for %arg5 = 0 to 32 {
      ...
      affine.for %arg5 = 0 to 32 {
        ...
        %9 = arith.mulf %8, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %13 = arith.mulf %12, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %17 = arith.mulf %16, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %21 = arith.mulf %20, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %25 = arith.mulf %24, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %29 = arith.mulf %28, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %33 = arith.mulf %32, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %37 = arith.mulf %36, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %41 = arith.mulf %40, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %45 = arith.mulf %44, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %49 = arith.mulf %48, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %53 = arith.mulf %52, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %57 = arith.mulf %56, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %61 = arith.mulf %60, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %65 = arith.mulf %64, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %69 = arith.mulf %68, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %73 = arith.mulf %72, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %77 = arith.mulf %76, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %81 = arith.mulf %80, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %85 = arith.mulf %84, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %89 = arith.mulf %88, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %93 = arith.mulf %92, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %97 = arith.mulf %96, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %101 = arith.mulf %100, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %105 = arith.mulf %104, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %109 = arith.mulf %108, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %113 = arith.mulf %112, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %117 = arith.mulf %116, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %121 = arith.mulf %120, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %125 = arith.mulf %124, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %129 = arith.mulf %128, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
        ...
        %133 = arith.mulf %132, %cst {timing = #hlscpp.t<2 -> 6, 4, 1>} : f32
