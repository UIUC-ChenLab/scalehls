...
class LinalgStructuredOpConfig(YAMLObject):
    ...
    def __init__(
        ...
        self.assignments = [
            ScalarAssign(write_use.tensor_name,
                         read_expr.to_scalar_expression())
    ...
    def __repr__(self):
        lines = [
            f"LinalgGenericOpConfig(reduction_dims={self.reduction_dims},"]
