...
// CHECK:     } {loop_directive = #hls.ld<pipeline=true, targetII=1, dataflow=false, flatten=false>, parallel}
// CHECK:     return
// CHECK:   }
...
// CHECK:       } {loop_directive = #hls.ld<pipeline=true, targetII=1, dataflow=false, flatten=false>, parallel, point}
// CHECK:     } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, point}
// CHECK:     return
// CHECK:   }
...
// CHECK:             }
// CHECK:           } {loop_directive = #hls.ld<pipeline=true, targetII=1, dataflow=false, flatten=false>, parallel, point}
// CHECK:         } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel, point}
// CHECK:       } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel, point}
// CHECK:     } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, point}
// CHECK:     return
// CHECK:   }
...
// CHECK:     return
// CHECK:   }
// CHECK:   func.func @forward_node17(%arg0: memref<16x14x14xi8, #map9, 7>, %arg1: memref<64x28x28xi8, #map9, 12>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK:     affine.for %arg5 = 0 to 16 {
// CHECK:       affine.for %arg6 = 0 to 14 step 2 {
// CHECK:         affine.for %arg7 = 0 to 14 step 2 {
// CHECK:           %0 = affine.load %arg0[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:           affine.store %0, %arg1[%arg5 + symbol(%arg2) * 16, %arg6 + symbol(%arg3) * 14, %arg7 + symbol(%arg4) * 14] : memref<64x28x28xi8, #map9, 12>
// CHECK:           %1 = affine.load %arg0[%arg5, %arg6, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:           affine.store %1, %arg1[%arg5 + symbol(%arg2) * 16, %arg6 + symbol(%arg3) * 14, %arg7 + symbol(%arg4) * 14 + 1] : memref<64x28x28xi8, #map9, 12>
// CHECK:           %2 = affine.load %arg0[%arg5, %arg6 + 1, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:           affine.store %2, %arg1[%arg5 + symbol(%arg2) * 16, %arg6 + symbol(%arg3) * 14 + 1, %arg7 + symbol(%arg4) * 14] : memref<64x28x28xi8, #map9, 12>
// CHECK:           %3 = affine.load %arg0[%arg5, %arg6 + 1, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:           affine.store %3, %arg1[%arg5 + symbol(%arg2) * 16, %arg6 + symbol(%arg3) * 14 + 1, %arg7 + symbol(%arg4) * 14 + 1] : memref<64x28x28xi8, #map9, 12>
// CHECK:         } {loop_directive = #hls.ld<pipeline=true, targetII=1, dataflow=false, flatten=false>, parallel}
// CHECK:       } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel}
// CHECK:     } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel}
// CHECK:     return
// CHECK:   }
// CHECK:   func.func @forward_node18(%arg0: memref<16x14x14xi8, #map9, 7>, %arg1: memref<16x16xi8, 7>, %arg2: memref<16x14x14xi8, #map9, 7>, %arg3: memref<16x14x14xi8, #map9, 7>) attributes {inline} {
// CHECK:     affine.for %arg4 = 0 to 16 {
// CHECK:       affine.for %arg5 = 0 to 16 {
// CHECK:         affine.for %arg6 = 0 to 14 step 2 {
// CHECK:           affine.for %arg7 = 0 to 14 step 2 {
// CHECK:             %0 = affine.load %arg0[%arg4, %arg6, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %1 = affine.load %arg1[%arg5, %arg4] : memref<16x16xi8, 7>
// CHECK:             %2 = affine.load %arg2[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %3 = affine.load %arg3[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %4 = hls.affine.select #set(%arg4) %2, %3 : i8
// CHECK:             %5 = arith.muli %0, %1 : i8
// CHECK:             %6 = arith.addi %4, %5 : i8
// CHECK:             affine.store %6, %arg3[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %7 = affine.load %arg0[%arg4, %arg6, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %8 = affine.load %arg2[%arg5, %arg6, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %9 = affine.load %arg3[%arg5, %arg6, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %10 = hls.affine.select #set(%arg4) %8, %9 : i8
// CHECK:             %11 = arith.muli %7, %1 : i8
// CHECK:             %12 = arith.addi %10, %11 : i8
// CHECK:             affine.store %12, %arg3[%arg5, %arg6, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %13 = affine.load %arg0[%arg4, %arg6 + 1, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %14 = affine.load %arg2[%arg5, %arg6 + 1, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %15 = affine.load %arg3[%arg5, %arg6 + 1, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %16 = hls.affine.select #set(%arg4) %14, %15 : i8
// CHECK:             %17 = arith.muli %13, %1 : i8
// CHECK:             %18 = arith.addi %16, %17 : i8
// CHECK:             affine.store %18, %arg3[%arg5, %arg6 + 1, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %19 = affine.load %arg0[%arg4, %arg6 + 1, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %20 = affine.load %arg2[%arg5, %arg6 + 1, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %21 = affine.load %arg3[%arg5, %arg6 + 1, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %22 = hls.affine.select #set(%arg4) %20, %21 : i8
// CHECK:             %23 = arith.muli %19, %1 : i8
// CHECK:             %24 = arith.addi %22, %23 : i8
// CHECK:             affine.store %24, %arg3[%arg5, %arg6 + 1, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:           } {loop_directive = #hls.ld<pipeline=true, targetII=1, dataflow=false, flatten=false>, parallel, point}
// CHECK:         } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel, point}
// CHECK:       } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel, point}
// CHECK:     } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, point}
// CHECK:     return
// CHECK:   }
// CHECK:   func.func @forward_node19(%arg0: memref<64x28x28xi8, #map9, 12>, %arg1: memref<16x14x14xi8, #map9, 7>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK:     affine.for %arg5 = 0 to 16 {
// CHECK:       affine.for %arg6 = 0 to 14 step 2 {
// CHECK:         affine.for %arg7 = 0 to 14 step 2 {
// CHECK:           %0 = affine.load %arg0[%arg5 + symbol(%arg2) * 16, %arg6 + symbol(%arg3) * 14, %arg7 + symbol(%arg4) * 14] : memref<64x28x28xi8, #map9, 12>
// CHECK:           affine.store %0, %arg1[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:           %1 = affine.load %arg0[%arg5 + symbol(%arg2) * 16, %arg6 + symbol(%arg3) * 14, %arg7 + symbol(%arg4) * 14 + 1] : memref<64x28x28xi8, #map9, 12>
// CHECK:           affine.store %1, %arg1[%arg5, %arg6, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:           %2 = affine.load %arg0[%arg5 + symbol(%arg2) * 16, %arg6 + symbol(%arg3) * 14 + 1, %arg7 + symbol(%arg4) * 14] : memref<64x28x28xi8, #map9, 12>
// CHECK:           affine.store %2, %arg1[%arg5, %arg6 + 1, %arg7] : memref<16x14x14xi8, #map9, 7>
// CHECK:           %3 = affine.load %arg0[%arg5 + symbol(%arg2) * 16, %arg6 + symbol(%arg3) * 14 + 1, %arg7 + symbol(%arg4) * 14 + 1] : memref<64x28x28xi8, #map9, 12>
// CHECK:           affine.store %3, %arg1[%arg5, %arg6 + 1, %arg7 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:         } {loop_directive = #hls.ld<pipeline=true, targetII=1, dataflow=false, flatten=false>, parallel}
// CHECK:       } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel}
// CHECK:     } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel}
// CHECK:     return
...
// CHECK:     return
// CHECK:   }
// CHECK:   func.func @forward_node21(%arg0: memref<64x28x28xi8, #map9, 12>, %arg1: memref<16x14x14xi8, #map9, 7>, %arg2: index, %arg3: index, %arg4: index, %arg5: index, %arg6: index) attributes {inline} {
// CHECK:     affine.for %arg7 = 0 to 16 {
// CHECK:       affine.for %arg8 = 0 to 14 step 2 {
// CHECK:         affine.for %arg9 = 0 to 14 step 2 {
// CHECK:           %0 = affine.load %arg0[%arg7 + symbol(%arg2) * 16, %arg8 + symbol(%arg3) + symbol(%arg4) * 14 - 1, %arg9 + symbol(%arg5) + symbol(%arg6) * 14 - 1] : memref<64x28x28xi8, #map9, 12>
// CHECK:           affine.store %0, %arg1[%arg7, %arg8, %arg9] : memref<16x14x14xi8, #map9, 7>
// CHECK:           %1 = affine.load %arg0[%arg7 + symbol(%arg2) * 16, %arg8 + symbol(%arg3) + symbol(%arg4) * 14 - 1, %arg9 + symbol(%arg5) + symbol(%arg6) * 14] : memref<64x28x28xi8, #map9, 12>
// CHECK:           affine.store %1, %arg1[%arg7, %arg8, %arg9 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:           %2 = affine.load %arg0[%arg7 + symbol(%arg2) * 16, %arg8 + symbol(%arg3) + symbol(%arg4) * 14, %arg9 + symbol(%arg5) + symbol(%arg6) * 14 - 1] : memref<64x28x28xi8, #map9, 12>
// CHECK:           affine.store %2, %arg1[%arg7, %arg8 + 1, %arg9] : memref<16x14x14xi8, #map9, 7>
// CHECK:           %3 = affine.load %arg0[%arg7 + symbol(%arg2) * 16, %arg8 + symbol(%arg3) + symbol(%arg4) * 14, %arg9 + symbol(%arg5) + symbol(%arg6) * 14] : memref<64x28x28xi8, #map9, 12>
// CHECK:           affine.store %3, %arg1[%arg7, %arg8 + 1, %arg9 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:         } {loop_directive = #hls.ld<pipeline=true, targetII=1, dataflow=false, flatten=false>, parallel}
// CHECK:       } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel}
// CHECK:     } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel}
// CHECK:     return
// CHECK:   }
// CHECK:   func.func @forward_node16(%arg0: memref<64x64x3x3xi8, 12>, %arg1: !hls.stream<i1, 1>, %arg2: memref<64x28x28xi8, #map9, 12>, %arg3: memref<64x28x28xi8, #map9, 12>, %arg4: !hls.stream<i1, 1>, %arg5: memref<64x28x28xi8, #map9, 12>) {
// CHECK:     %true = arith.constant true
...
// CHECK:       %6 = hls.dataflow.buffer {depth = 1 : i32, init_value = -24 : i8} : memref<16x14x14xi8, #map9, 7>
// CHECK:       %7 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x16xi8, 7>
// CHECK:       %8 = hls.dataflow.buffer {depth = 1 : i32, init_value = -24 : i8} : memref<16x14x14xi8, #map9, 7>
// CHECK:       func.call @forward_node21(%arg2, %8, %5, %4, %1, %3, %0) : (memref<64x28x28xi8, #map9, 12>, memref<16x14x14xi8, #map9, 7>, index, index, index, index, index) -> ()
// CHECK:       func.call @forward_node20(%arg0, %7, %2, %5, %4, %3) : (memref<64x64x3x3xi8, 12>, memref<16x16xi8, 7>, index, index, index, index) -> ()
// CHECK:       func.call @forward_node19(%arg3, %6, %2, %1, %0) : (memref<64x28x28xi8, #map9, 12>, memref<16x14x14xi8, #map9, 7>, index, index, index) -> ()
// CHECK:       %9 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, #map9, 7>
// CHECK:       func.call @forward_node18(%8, %7, %6, %9) : (memref<16x14x14xi8, #map9, 7>, memref<16x16xi8, 7>, memref<16x14x14xi8, #map9, 7>, memref<16x14x14xi8, #map9, 7>) -> ()
// CHECK:       func.call @forward_node17(%9, %arg5, %2, %1, %0) : (memref<16x14x14xi8, #map9, 7>, memref<64x28x28xi8, #map9, 12>, index, index, index) -> ()
// CHECK:     } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=true, flatten=false>}
// CHECK:     hls.dataflow.stream_write %arg4, %true : <i1, 1>, i1
// CHECK:     return
// CHECK:   }
// CHECK:   func.func @forward_node23(%arg0: memref<16x14x14xi8, #map9, 7>, %arg1: memref<64x28x28xi8, #map9, 12>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK:     affine.for %arg5 = 0 to 16 {
// CHECK:       affine.for %arg6 = 0 to 14 step 2 {
// CHECK:         affine.for %arg7 = 0 to 14 step 2 {
// CHECK:           %0 = affine.load %arg0[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #map9, 7>
...
// CHECK:     return
// CHECK:   }
// CHECK:   func.func @forward_node24(%arg0: memref<16x14x14xi8, #map9, 7>, %arg1: memref<16x16xi8, 7>, %arg2: memref<16x14x14xi8, #map9, 7>, %arg3: memref<16x14x14xi8, #map9, 7>, %arg4: index, %arg5: index, %arg6: index) attributes {inline} {
// CHECK:     %c-24_i8 = arith.constant -24 : i8
// CHECK:     affine.for %arg7 = 0 to 16 {
// CHECK:       affine.for %arg8 = 0 to 16 {
// CHECK:         affine.for %arg9 = 0 to 14 step 2 {
// CHECK:           affine.for %arg10 = 0 to 14 step 2 {
// CHECK:             %0 = affine.load %arg0[%arg7, %arg9, %arg10] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %1 = affine.load %arg1[%arg8, %arg7] : memref<16x16xi8, 7>
// CHECK:             %2 = affine.load %arg2[%arg8, %arg9, %arg10] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %3 = affine.load %arg3[%arg8, %arg9, %arg10] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %4 = hls.affine.select #set(%arg7) %2, %3 : i8
// CHECK:             %5 = arith.muli %0, %1 : i8
// CHECK:             %6 = arith.addi %4, %5 : i8
...
// CHECK:             affine.store %9, %arg3[%arg8, %arg9, %arg10] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %10 = affine.load %arg0[%arg7, %arg9, %arg10 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %11 = affine.load %arg2[%arg8, %arg9, %arg10 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %12 = affine.load %arg3[%arg8, %arg9, %arg10 + 1] : memref<16x14x14xi8, #map9, 7>
...
// CHECK:             affine.store %18, %arg3[%arg8, %arg9, %arg10 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %19 = affine.load %arg0[%arg7, %arg9 + 1, %arg10] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %20 = affine.load %arg2[%arg8, %arg9 + 1, %arg10] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %21 = affine.load %arg3[%arg8, %arg9 + 1, %arg10] : memref<16x14x14xi8, #map9, 7>
...
// CHECK:             affine.store %27, %arg3[%arg8, %arg9 + 1, %arg10] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %28 = affine.load %arg0[%arg7, %arg9 + 1, %arg10 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %29 = affine.load %arg2[%arg8, %arg9 + 1, %arg10 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:             %30 = affine.load %arg3[%arg8, %arg9 + 1, %arg10 + 1] : memref<16x14x14xi8, #map9, 7>
...
// CHECK:             affine.store %36, %arg3[%arg8, %arg9 + 1, %arg10 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:           } {loop_directive = #hls.ld<pipeline=true, targetII=1, dataflow=false, flatten=false>, parallel, point}
// CHECK:         } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel, point}
// CHECK:       } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel, point}
// CHECK:     } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, point}
// CHECK:     return
// CHECK:   }
// CHECK:   func.func @forward_node25(%arg0: memref<64x28x28xi8, #map9, 12>, %arg1: memref<16x14x14xi8, #map9, 7>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK:     affine.for %arg5 = 0 to 16 {
// CHECK:       affine.for %arg6 = 0 to 14 step 2 {
// CHECK:         affine.for %arg7 = 0 to 14 step 2 {
// CHECK:           %0 = affine.load %arg0[%arg5 + symbol(%arg2) * 16, %arg6 + symbol(%arg3) * 14, %arg7 + symbol(%arg4) * 14] : memref<64x28x28xi8, #map9, 12>
...
// CHECK:     return
// CHECK:   }
// CHECK:   func.func @forward_node27(%arg0: memref<64x56x56xi8, #map13, 12>, %arg1: memref<16x14x14xi8, #map9, 7>, %arg2: index, %arg3: index, %arg4: index, %arg5: index, %arg6: index) attributes {inline} {
// CHECK:     affine.for %arg7 = 0 to 16 {
// CHECK:       affine.for %arg8 = 0 to 14 step 2 {
// CHECK:         affine.for %arg9 = 0 to 14 step 2 {
// CHECK:           %0 = affine.load %arg0[%arg7 + symbol(%arg2) * 16, %arg8 * 2 + symbol(%arg3) + symbol(%arg4) * 28 - 1, %arg9 * 2 + symbol(%arg5) + symbol(%arg6) * 28 - 1] : memref<64x56x56xi8, #map13, 12>
// CHECK:           affine.store %0, %arg1[%arg7, %arg8, %arg9] : memref<16x14x14xi8, #map9, 7>
// CHECK:           %1 = affine.load %arg0[%arg7 + symbol(%arg2) * 16, %arg8 * 2 + symbol(%arg3) + symbol(%arg4) * 28 - 1, %arg9 * 2 + symbol(%arg5) + symbol(%arg6) * 28 + 1] : memref<64x56x56xi8, #map13, 12>
// CHECK:           affine.store %1, %arg1[%arg7, %arg8, %arg9 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:           %2 = affine.load %arg0[%arg7 + symbol(%arg2) * 16, %arg8 * 2 + symbol(%arg3) + symbol(%arg4) * 28 + 1, %arg9 * 2 + symbol(%arg5) + symbol(%arg6) * 28 - 1] : memref<64x56x56xi8, #map13, 12>
// CHECK:           affine.store %2, %arg1[%arg7, %arg8 + 1, %arg9] : memref<16x14x14xi8, #map9, 7>
// CHECK:           %3 = affine.load %arg0[%arg7 + symbol(%arg2) * 16, %arg8 * 2 + symbol(%arg3) + symbol(%arg4) * 28 + 1, %arg9 * 2 + symbol(%arg5) + symbol(%arg6) * 28 + 1] : memref<64x56x56xi8, #map13, 12>
// CHECK:           affine.store %3, %arg1[%arg7, %arg8 + 1, %arg9 + 1] : memref<16x14x14xi8, #map9, 7>
// CHECK:         } {loop_directive = #hls.ld<pipeline=true, targetII=1, dataflow=false, flatten=false>, parallel}
// CHECK:       } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel}
// CHECK:     } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=false, flatten=true>, parallel}
// CHECK:     return
// CHECK:   }
// CHECK:   func.func @forward_node22(%arg0: !hls.stream<i1, 1>, %arg1: memref<64x56x56xi8, #map13, 12>, %arg2: memref<64x64x3x3xi8, 12>, %arg3: memref<64x28x28xi8, #map9, 12>, %arg4: !hls.stream<i1, 1>, %arg5: memref<64x28x28xi8, #map9, 12>) {
// CHECK:     %true = arith.constant true
// CHECK:     hls.dataflow.stream_read %arg0 : (!hls.stream<i1, 1>) -> ()
// CHECK:     affine.for %arg6 = 0 to 576 {
// CHECK:       %0 = affine.apply #map5(%arg6)
...
// CHECK:       %6 = hls.dataflow.buffer {depth = 1 : i32, init_value = -24 : i8} : memref<16x14x14xi8, #map9, 7>
// CHECK:       %7 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x16xi8, 7>
// CHECK:       %8 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, #map9, 7>
// CHECK:       func.call @forward_node27(%arg1, %8, %5, %4, %1, %3, %0) : (memref<64x56x56xi8, #map13, 12>, memref<16x14x14xi8, #map9, 7>, index, index, index, index, index) -> ()
// CHECK:       func.call @forward_node26(%arg2, %7, %2, %5, %4, %3) : (memref<64x64x3x3xi8, 12>, memref<16x16xi8, 7>, index, index, index, index) -> ()
// CHECK:       func.call @forward_node25(%arg3, %6, %2, %1, %0) : (memref<64x28x28xi8, #map9, 12>, memref<16x14x14xi8, #map9, 7>, index, index, index) -> ()
// CHECK:       %9 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, #map9, 7>
// CHECK:       func.call @forward_node24(%8, %7, %6, %9, %3, %5, %4) : (memref<16x14x14xi8, #map9, 7>, memref<16x16xi8, 7>, memref<16x14x14xi8, #map9, 7>, memref<16x14x14xi8, #map9, 7>, index, index, index) -> ()
// CHECK:       func.call @forward_node23(%9, %arg5, %2, %1, %0) : (memref<16x14x14xi8, #map9, 7>, memref<64x28x28xi8, #map9, 12>, index, index, index) -> ()
// CHECK:     } {loop_directive = #hls.ld<pipeline=false, targetII=1, dataflow=true, flatten=false>}
// CHECK:     hls.dataflow.stream_write %arg4, %true : <i1, 1>, i1
// CHECK:     return
// CHECK:   }
...
// CHECK:     %9 = hls.axi.port %8, %arg18 : <0 : i32>, (!hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) -> memref<64x28x28xi8, #map9, 12>
// CHECK:     %10 = hls.axi.bundle "axi17" : <0 : i32>
// CHECK:     %11 = hls.axi.port %10, %arg17 : <0 : i32>, (!hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) -> memref<64x28x28xi8, #map9, 12>
...
// CHECK:     %15 = hls.axi.port %14, %arg15 : <0 : i32>, (!hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) -> memref<64x28x28xi8, #map9, 12>
// CHECK:     %16 = hls.axi.bundle "axi14" : <0 : i32>
// CHECK:     %17 = hls.axi.port %16, %arg14 : <0 : i32>, (!hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) -> memref<64x28x28xi8, #map9, 12>
// CHECK:     %18 = hls.axi.bundle "axi13" : <0 : i32>
// CHECK:     %19 = hls.axi.port %18, %arg13 : <0 : i32>, (!hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) -> memref<64x28x28xi8, #map9, 12>
...
// CHECK:     %23 = hls.axi.port %22, %arg11 : <0 : i32>, (!hls.axi<memref<64x56x56xi8, 12>, 0 : i32>) -> memref<64x56x56xi8, #map13, 12>
...
// CHECK:     call @forward_node22(%48, %23, %33, %15, %49, %17) : (!hls.stream<i1, 1>, memref<64x56x56xi8, #map13, 12>, memref<64x64x3x3xi8, 12>, memref<64x28x28xi8, #map9, 12>, !hls.stream<i1, 1>, memref<64x28x28xi8, #map9, 12>) -> ()
// CHECK:     %50 = hls.dataflow.stream {depth = 1 : i32} : <i1, 1>
// CHECK:     call @forward_node16(%35, %49, %19, %9, %50, %11) : (memref<64x64x3x3xi8, 12>, !hls.stream<i1, 1>, memref<64x28x28xi8, #map9, 12>, memref<64x28x28xi8, #map9, 12>, !hls.stream<i1, 1>, memref<64x28x28xi8, #map9, 12>) -> ()
...
module attributes {torch.debug_module_name = "ResNet"} {
  ...
  func.func @forward(%arg0: !hls.axi<memref<64x56x56xi8, 12>, 0 : i32>, %arg1: !hls.axi<memref<64x56x56xi8, 12>, 0 : i32>, %arg2: !hls.axi<memref<64x56x56xi8, 12>, 0 : i32>, %arg3: !hls.axi<memref<1000x64xi8, 12>, 0 : i32>, %arg4: !hls.axi<memref<64x64xi8, 12>, 0 : i32>, %arg5: !hls.axi<memref<64x64x3x3xi8, 12>, 0 : i32>, %arg6: !hls.axi<memref<64x64x3x3xi8, 12>, 0 : i32>, %arg7: !hls.axi<memref<1000xi8, 12>, 0 : i32>, %arg8: !hls.axi<memref<1000xi8, 12>, 0 : i32>, %arg9: !hls.axi<memref<64x56x56xi8, 12>, 0 : i32>, %arg10: !hls.axi<memref<64x56x56xi8, 12>, 0 : i32>, %arg11: !hls.axi<memref<64x56x56xi8, 12>, 0 : i32>, %arg12: !hls.axi<memref<64x56x56xi8, 12>, 0 : i32>, %arg13: !hls.axi<memref<64x28x28xi8, 12>, 0 : i32>, %arg14: !hls.axi<memref<64x28x28xi8, 12>, 0 : i32>, %arg15: !hls.axi<memref<64x28x28xi8, 12>, 0 : i32>, %arg16: !hls.axi<memref<64x28x28xi8, 12>, 0 : i32>, %arg17: !hls.axi<memref<64x28x28xi8, 12>, 0 : i32>, %arg18: !hls.axi<memref<64x28x28xi8, 12>, 0 : i32>, %arg19: !hls.axi<memref<64x28x28xi8, 12>, 0 : i32>, %arg20: !hls.axi<memref<64x28x28xi8, 12>, 0 : i32>, %arg21: !hls.axi<memref<64x28x28xi8, 12>, 0 : i32>, %arg22: !hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) attributes {func_directive = #hls.fd<pipeline=false, targetInterval=1, dataflow=true>, top_func} {
    ...
    %9 = hls.axi.port %8, %arg18 : <0 : i32>, (!hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) -> memref<64x28x28xi8, 12>
    %10 = hls.axi.bundle "axi17" : <0 : i32>
    %11 = hls.axi.port %10, %arg17 : <0 : i32>, (!hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) -> memref<64x28x28xi8, 12>
    ...
    %15 = hls.axi.port %14, %arg15 : <0 : i32>, (!hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) -> memref<64x28x28xi8, 12>
    %16 = hls.axi.bundle "axi14" : <0 : i32>
    %17 = hls.axi.port %16, %arg14 : <0 : i32>, (!hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) -> memref<64x28x28xi8, 12>
    %18 = hls.axi.bundle "axi13" : <0 : i32>
    %19 = hls.axi.port %18, %arg13 : <0 : i32>, (!hls.axi<memref<64x28x28xi8, 12>, 0 : i32>) -> memref<64x28x28xi8, 12>
    ...
    %23 = hls.axi.port %22, %arg11 : <0 : i32>, (!hls.axi<memref<64x56x56xi8, 12>, 0 : i32>) -> memref<64x56x56xi8, 12>
    ...
    call @forward_node22(%48, %23, %33, %15, %49, %17) : (!hls.stream<i1, 1>, memref<64x56x56xi8, 12>, memref<64x64x3x3xi8, 12>, memref<64x28x28xi8, 12>, !hls.stream<i1, 1>, memref<64x28x28xi8, 12>) -> ()
    %50 = hls.dataflow.stream {depth = 1 : i32} : <i1, 1>
    call @forward_node16(%35, %49, %19, %9, %50, %11) : (memref<64x64x3x3xi8, 12>, !hls.stream<i1, 1>, memref<64x28x28xi8, 12>, memref<64x28x28xi8, 12>, !hls.stream<i1, 1>, memref<64x28x28xi8, 12>) -> ()
