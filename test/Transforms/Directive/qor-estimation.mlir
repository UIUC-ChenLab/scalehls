...
module  {
  // CHECK: attributes {func_directive = #hls.func<pipeline=false, targetInterval=1, dataflow=false>, resource = #hls.res<lut=0, dsp=11, bram=0>, timing = #hls.time<0 -> 4119, 4119, 4119>, top_func}
  func.func @test_syrk(%arg0: f32, %arg1: f32, %arg2: memref<16x16xf32, #map0, #hls.mem<bram_s2p>>, %arg3: memref<16x16xf32, #map1, #hls.mem<bram_s2p>>) attributes {func_directive = #hls.func<pipeline=false, targetInterval=1, dataflow=false>, top_func} {
