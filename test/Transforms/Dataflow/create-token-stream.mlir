...
// CHECK:       hls.dataflow.node() -> (%0, %arg10) {inputTaps = [], level = 6 : i32} : () -> (!hls.stream<i1, 1>, memref<64x56x56xi8, 12>) {
// CHECK:       ^bb0(%arg12: !hls.stream<i1, 1>, %arg13: memref<64x56x56xi8, 12>):
// CHECK:         affine.for %arg14 = 0 to 4 {
// CHECK:           affine.for %arg15 = 0 to 4 {
// CHECK:             affine.for %arg16 = 0 to 4 {
// CHECK:               hls.dataflow.schedule legal(%arg14, %arg16, %arg13, %arg15) : index, index, memref<64x56x56xi8, 12>, index {
// CHECK:               ^bb0(%arg17: index, %arg18: index, %arg19: memref<64x56x56xi8, 12>, %arg20: index):
// CHECK:                 %13 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, 7>
// CHECK:                 hls.dataflow.node(%arg19) -> (%13) [%arg17, %arg20, %arg18] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x56x56xi8, 12>) -> memref<16x14x14xi8, 7>[index, index, index] {
// CHECK:                 ^bb0(%arg21: memref<64x56x56xi8, 12>, %arg22: memref<16x14x14xi8, 7>, %arg23: index, %arg24: index, %arg25: index):
// CHECK:                   affine.for %arg26 = 0 to 16 {
// CHECK:                     affine.for %arg27 = 0 to 14 {
// CHECK:                       affine.for %arg28 = 0 to 14 {
// CHECK:                         %15 = affine.load %arg21[%arg26 + symbol(%arg23) * 16, %arg27 + symbol(%arg24) * 14, %arg28 + symbol(%arg25) * 14] : memref<64x56x56xi8, 12>
// CHECK:                         affine.store %15, %arg22[%arg26, %arg27, %arg28] : memref<16x14x14xi8, 7>
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
// CHECK:                   } {parallel}
// CHECK:                 }
// CHECK:                 %14 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, 7>
// CHECK:                 hls.dataflow.node(%13) -> (%14) {inputTaps = [0 : i32], level = 1 : i32} : (memref<16x14x14xi8, 7>) -> memref<16x14x14xi8, 7> {
// CHECK:                 ^bb0(%arg21: memref<16x14x14xi8, 7>, %arg22: memref<16x14x14xi8, 7>):
...
// CHECK:                         %15 = affine.load %arg21[%arg23, %arg24, %arg25] : memref<16x14x14xi8, 7>
// CHECK:                         %16 = arith.cmpi ugt, %15, %c-24_i8 : i8
// CHECK:                         %17 = arith.select %16, %15, %c-24_i8 : i8
// CHECK:                         affine.store %17, %arg22[%arg23, %arg24, %arg25] : memref<16x14x14xi8, 7>
// CHECK:                       } {parallel, point}
// CHECK:                     } {parallel, point}
// CHECK:                   } {parallel, point}
// CHECK:                 }
// CHECK:                 hls.dataflow.node(%14) -> (%arg19) [%arg17, %arg20, %arg18] {inputTaps = [0 : i32], level = 0 : i32} : (memref<16x14x14xi8, 7>) -> memref<64x56x56xi8, 12>[index, index, index] {
// CHECK:                 ^bb0(%arg21: memref<16x14x14xi8, 7>, %arg22: memref<64x56x56xi8, 12>, %arg23: index, %arg24: index, %arg25: index):
// CHECK:                   affine.for %arg26 = 0 to 16 {
// CHECK:                     affine.for %arg27 = 0 to 14 {
// CHECK:                       affine.for %arg28 = 0 to 14 {
// CHECK:                         %15 = affine.load %arg21[%arg26, %arg27, %arg28] : memref<16x14x14xi8, 7>
// CHECK:                         affine.store %15, %arg22[%arg26 + symbol(%arg23) * 16, %arg27 + symbol(%arg24) * 14, %arg28 + symbol(%arg25) * 14] : memref<64x56x56xi8, 12>
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
// CHECK:                   } {parallel}
// CHECK:                 }
...
// CHECK:       hls.dataflow.node(%0, %arg10) -> (%2, %1, %4, %3) {inputTaps = [0 : i32, 0 : i32], level = 5 : i32} : (!hls.stream<i1, 1>, memref<64x56x56xi8, 12>) -> (!hls.stream<i1, 3>, memref<64x56x56xi8, 12>, !hls.stream<i1, 1>, memref<64x56x56xi8, 12>) {
// CHECK:       ^bb0(%arg12: !hls.stream<i1, 1>, %arg13: memref<64x56x56xi8, 12>, %arg14: !hls.stream<i1, 3>, %arg15: memref<64x56x56xi8, 12>, %arg16: !hls.stream<i1, 1>, %arg17: memref<64x56x56xi8, 12>):
...
// CHECK:               %13 = affine.load %arg13[%arg18, %arg19, %arg20] : memref<64x56x56xi8, 12>
// CHECK:               affine.store %13, %arg15[%arg18, %arg19, %arg20] : memref<64x56x56xi8, 12>
// CHECK:             } {parallel}
// CHECK:           } {parallel}
// CHECK:         } {parallel}
// CHECK:         affine.for %arg18 = 0 to 64 {
...
// CHECK:             affine.for %arg20 = 0 to 56 {
// CHECK:               %13 = affine.load %arg13[%arg18, %arg19, %arg20] : memref<64x56x56xi8, 12>
// CHECK:               affine.store %13, %arg17[%arg18, %arg19, %arg20] : memref<64x56x56xi8, 12>
// CHECK:             } {parallel}
// CHECK:           } {parallel}
// CHECK:         } {parallel}
// CHECK:         %true = arith.constant true
...
// CHECK:       hls.dataflow.node(%4, %3, %arg11) -> (%6, %5) {inputTaps = [0 : i32, 0 : i32, 0 : i32], level = 4 : i32} : (!hls.stream<i1, 1>, memref<64x56x56xi8, 12>, memref<64x64x3x3xi8, 12>) -> (!hls.stream<i1, 1>, memref<64x28x28xi8, 12>) {
// CHECK:       ^bb0(%arg12: !hls.stream<i1, 1>, %arg13: memref<64x56x56xi8, 12>, %arg14: memref<64x64x3x3xi8, 12>, %arg15: !hls.stream<i1, 1>, %arg16: memref<64x28x28xi8, 12>):
// CHECK:         hls.dataflow.stream_read %arg12 : (!hls.stream<i1, 1>) -> ()
...
// CHECK:                     hls.dataflow.schedule legal(%arg19, %arg16, %arg22, %arg18, %arg21, %arg13, %arg17, %arg14, %arg20) : index, memref<64x28x28xi8, 12>, index, index, index, memref<64x56x56xi8, 12>, index, memref<64x64x3x3xi8, 12>, index {
// CHECK:                     ^bb0(%arg23: index, %arg24: memref<64x28x28xi8, 12>, %arg25: index, %arg26: index, %arg27: index, %arg28: memref<64x56x56xi8, 12>, %arg29: index, %arg30: memref<64x64x3x3xi8, 12>, %arg31: index):
// CHECK:                       %13 = hls.dataflow.buffer {depth = 1 : i32, init_value = -24 : i8} : memref<16x14x14xi8, 7>
// CHECK:                       %14 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x16xi8, 7>
// CHECK:                       %15 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, 7>
// CHECK:                       hls.dataflow.node(%arg28) -> (%15) [%arg29, %arg26, %arg27, %arg23, %arg25] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x56x56xi8, 12>) -> memref<16x14x14xi8, 7>[index, index, index, index, index] {
// CHECK:                       ^bb0(%arg32: memref<64x56x56xi8, 12>, %arg33: memref<16x14x14xi8, 7>, %arg34: index, %arg35: index, %arg36: index, %arg37: index, %arg38: index):
// CHECK:                         affine.for %arg39 = 0 to 16 {
// CHECK:                           affine.for %arg40 = 0 to 14 step 2 {
// CHECK:                             affine.for %arg41 = 0 to 14 step 2 {
// CHECK:                               %17 = affine.load %arg32[%arg39 + symbol(%arg34) * 16, %arg40 * 2 + symbol(%arg35) + symbol(%arg36) * 28 - 1, %arg41 * 2 + symbol(%arg37) + symbol(%arg38) * 28 - 1] : memref<64x56x56xi8, 12>
// CHECK:                               affine.store %17, %arg33[%arg39, %arg40, %arg41] : memref<16x14x14xi8, 7>
// CHECK:                               %18 = affine.load %arg32[%arg39 + symbol(%arg34) * 16, %arg40 * 2 + symbol(%arg35) + symbol(%arg36) * 28 - 1, %arg41 * 2 + symbol(%arg37) + symbol(%arg38) * 28 + 1] : memref<64x56x56xi8, 12>
// CHECK:                               affine.store %18, %arg33[%arg39, %arg40, %arg41 + 1] : memref<16x14x14xi8, 7>
// CHECK:                               %19 = affine.load %arg32[%arg39 + symbol(%arg34) * 16, %arg40 * 2 + symbol(%arg35) + symbol(%arg36) * 28 + 1, %arg41 * 2 + symbol(%arg37) + symbol(%arg38) * 28 - 1] : memref<64x56x56xi8, 12>
// CHECK:                               affine.store %19, %arg33[%arg39, %arg40 + 1, %arg41] : memref<16x14x14xi8, 7>
// CHECK:                               %20 = affine.load %arg32[%arg39 + symbol(%arg34) * 16, %arg40 * 2 + symbol(%arg35) + symbol(%arg36) * 28 + 1, %arg41 * 2 + symbol(%arg37) + symbol(%arg38) * 28 + 1] : memref<64x56x56xi8, 12>
// CHECK:                               affine.store %20, %arg33[%arg39, %arg40 + 1, %arg41 + 1] : memref<16x14x14xi8, 7>
// CHECK:                             } {parallel}
// CHECK:                           } {parallel}
// CHECK:                         } {parallel}
// CHECK:                       }
// CHECK:                       hls.dataflow.node(%arg30) -> (%14) [%arg31, %arg29, %arg26, %arg23] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x64x3x3xi8, 12>) -> memref<16x16xi8, 7>[index, index, index, index] {
// CHECK:                       ^bb0(%arg32: memref<64x64x3x3xi8, 12>, %arg33: memref<16x16xi8, 7>, %arg34: index, %arg35: index, %arg36: index, %arg37: index):
// CHECK:                         affine.for %arg38 = 0 to 16 {
// CHECK:                           affine.for %arg39 = 0 to 16 {
// CHECK:                             %17 = affine.load %arg32[%arg38 + symbol(%arg34) * 16, %arg39 + symbol(%arg35) * 16, symbol(%arg36), symbol(%arg37)] : memref<64x64x3x3xi8, 12>
// CHECK:                             affine.store %17, %arg33[%arg38, %arg39] : memref<16x16xi8, 7>
// CHECK:                           } {parallel}
// CHECK:                         } {parallel}
// CHECK:                       }
// CHECK:                       hls.dataflow.node(%arg24) -> (%13) [%arg31, %arg27, %arg25] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x28x28xi8, 12>) -> memref<16x14x14xi8, 7>[index, index, index] {
// CHECK:                       ^bb0(%arg32: memref<64x28x28xi8, 12>, %arg33: memref<16x14x14xi8, 7>, %arg34: index, %arg35: index, %arg36: index):
// CHECK:                         affine.for %arg37 = 0 to 16 {
// CHECK:                           affine.for %arg38 = 0 to 14 step 2 {
// CHECK:                             affine.for %arg39 = 0 to 14 step 2 {
// CHECK:                               %17 = affine.load %arg32[%arg37 + symbol(%arg34) * 16, %arg38 + symbol(%arg35) * 14, %arg39 + symbol(%arg36) * 14] : memref<64x28x28xi8, 12>
// CHECK:                               affine.store %17, %arg33[%arg37, %arg38, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                               %18 = affine.load %arg32[%arg37 + symbol(%arg34) * 16, %arg38 + symbol(%arg35) * 14, %arg39 + symbol(%arg36) * 14 + 1] : memref<64x28x28xi8, 12>
// CHECK:                               affine.store %18, %arg33[%arg37, %arg38, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                               %19 = affine.load %arg32[%arg37 + symbol(%arg34) * 16, %arg38 + symbol(%arg35) * 14 + 1, %arg39 + symbol(%arg36) * 14] : memref<64x28x28xi8, 12>
// CHECK:                               affine.store %19, %arg33[%arg37, %arg38 + 1, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                               %20 = affine.load %arg32[%arg37 + symbol(%arg34) * 16, %arg38 + symbol(%arg35) * 14 + 1, %arg39 + symbol(%arg36) * 14 + 1] : memref<64x28x28xi8, 12>
// CHECK:                               affine.store %20, %arg33[%arg37, %arg38 + 1, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                             } {parallel}
// CHECK:                           } {parallel}
// CHECK:                         } {parallel}
// CHECK:                       }
// CHECK:                       %16 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, 7>
// CHECK:                       hls.dataflow.node(%15, %14, %13) -> (%16) [%arg23, %arg29, %arg26] {inputTaps = [0 : i32, 0 : i32, 0 : i32], level = 1 : i32} : (memref<16x14x14xi8, 7>, memref<16x16xi8, 7>, memref<16x14x14xi8, 7>) -> memref<16x14x14xi8, 7>[index, index, index] {
// CHECK:                       ^bb0(%arg32: memref<16x14x14xi8, 7>, %arg33: memref<16x16xi8, 7>, %arg34: memref<16x14x14xi8, 7>, %arg35: memref<16x14x14xi8, 7>, %arg36: index, %arg37: index, %arg38: index):
// CHECK:                         %c-24_i8 = arith.constant -24 : i8
// CHECK:                         affine.for %arg39 = 0 to 16 {
// CHECK:                           affine.for %arg40 = 0 to 16 {
// CHECK:                             affine.for %arg41 = 0 to 14 step 2 {
// CHECK:                               affine.for %arg42 = 0 to 14 step 2 {
// CHECK:                                 %17 = affine.load %arg32[%arg39, %arg41, %arg42] : memref<16x14x14xi8, 7>
// CHECK:                                 %18 = affine.load %arg33[%arg40, %arg39] : memref<16x16xi8, 7>
// CHECK:                                 %19 = affine.load %arg34[%arg40, %arg41, %arg42] : memref<16x14x14xi8, 7>
// CHECK:                                 %20 = affine.load %arg35[%arg40, %arg41, %arg42] : memref<16x14x14xi8, 7>
...
// CHECK:                                 affine.store %26, %arg35[%arg40, %arg41, %arg42] : memref<16x14x14xi8, 7>
// CHECK:                                 %27 = affine.load %arg32[%arg39, %arg41, %arg42 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %28 = affine.load %arg34[%arg40, %arg41, %arg42 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %29 = affine.load %arg35[%arg40, %arg41, %arg42 + 1] : memref<16x14x14xi8, 7>
...
// CHECK:                                 affine.store %35, %arg35[%arg40, %arg41, %arg42 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %36 = affine.load %arg32[%arg39, %arg41 + 1, %arg42] : memref<16x14x14xi8, 7>
// CHECK:                                 %37 = affine.load %arg34[%arg40, %arg41 + 1, %arg42] : memref<16x14x14xi8, 7>
// CHECK:                                 %38 = affine.load %arg35[%arg40, %arg41 + 1, %arg42] : memref<16x14x14xi8, 7>
...
// CHECK:                                 affine.store %44, %arg35[%arg40, %arg41 + 1, %arg42] : memref<16x14x14xi8, 7>
// CHECK:                                 %45 = affine.load %arg32[%arg39, %arg41 + 1, %arg42 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %46 = affine.load %arg34[%arg40, %arg41 + 1, %arg42 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %47 = affine.load %arg35[%arg40, %arg41 + 1, %arg42 + 1] : memref<16x14x14xi8, 7>
...
// CHECK:                                 affine.store %53, %arg35[%arg40, %arg41 + 1, %arg42 + 1] : memref<16x14x14xi8, 7>
// CHECK:                               } {parallel, point}
// CHECK:                             } {parallel, point}
// CHECK:                           } {parallel, point}
// CHECK:                         } {point}
// CHECK:                       }
// CHECK:                       hls.dataflow.node(%16) -> (%arg24) [%arg31, %arg27, %arg25] {inputTaps = [0 : i32], level = 0 : i32} : (memref<16x14x14xi8, 7>) -> memref<64x28x28xi8, 12>[index, index, index] {
// CHECK:                       ^bb0(%arg32: memref<16x14x14xi8, 7>, %arg33: memref<64x28x28xi8, 12>, %arg34: index, %arg35: index, %arg36: index):
// CHECK:                         affine.for %arg37 = 0 to 16 {
// CHECK:                           affine.for %arg38 = 0 to 14 step 2 {
// CHECK:                             affine.for %arg39 = 0 to 14 step 2 {
// CHECK:                               %17 = affine.load %arg32[%arg37, %arg38, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                               affine.store %17, %arg33[%arg37 + symbol(%arg34) * 16, %arg38 + symbol(%arg35) * 14, %arg39 + symbol(%arg36) * 14] : memref<64x28x28xi8, 12>
// CHECK:                               %18 = affine.load %arg32[%arg37, %arg38, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                               affine.store %18, %arg33[%arg37 + symbol(%arg34) * 16, %arg38 + symbol(%arg35) * 14, %arg39 + symbol(%arg36) * 14 + 1] : memref<64x28x28xi8, 12>
// CHECK:                               %19 = affine.load %arg32[%arg37, %arg38 + 1, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                               affine.store %19, %arg33[%arg37 + symbol(%arg34) * 16, %arg38 + symbol(%arg35) * 14 + 1, %arg39 + symbol(%arg36) * 14] : memref<64x28x28xi8, 12>
// CHECK:                               %20 = affine.load %arg32[%arg37, %arg38 + 1, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                               affine.store %20, %arg33[%arg37 + symbol(%arg34) * 16, %arg38 + symbol(%arg35) * 14 + 1, %arg39 + symbol(%arg36) * 14 + 1] : memref<64x28x28xi8, 12>
// CHECK:                             } {parallel}
// CHECK:                           } {parallel}
// CHECK:                         } {parallel}
// CHECK:                       }
...
// CHECK:       hls.dataflow.node(%arg8, %6, %5) -> (%8, %7) {inputTaps = [0 : i32, 0 : i32, 0 : i32], level = 3 : i32} : (memref<64x64x3x3xi8, 12>, !hls.stream<i1, 1>, memref<64x28x28xi8, 12>) -> (!hls.stream<i1, 1>, memref<64x28x28xi8, 12>) {
// CHECK:       ^bb0(%arg12: memref<64x64x3x3xi8, 12>, %arg13: !hls.stream<i1, 1>, %arg14: memref<64x28x28xi8, 12>, %arg15: !hls.stream<i1, 1>, %arg16: memref<64x28x28xi8, 12>):
...
// CHECK:                 affine.for %arg21 = 0 to 2 {
// CHECK:                   affine.for %arg22 = 0 to 2 {
// CHECK:                     hls.dataflow.schedule legal(%arg22, %arg18, %arg17, %arg19, %arg21, %arg16, %arg12, %arg14, %arg20) : index, index, index, index, index, memref<64x28x28xi8, 12>, memref<64x64x3x3xi8, 12>, memref<64x28x28xi8, 12>, index {
// CHECK:                     ^bb0(%arg23: index, %arg24: index, %arg25: index, %arg26: index, %arg27: index, %arg28: memref<64x28x28xi8, 12>, %arg29: memref<64x64x3x3xi8, 12>, %arg30: memref<64x28x28xi8, 12>, %arg31: index):
// CHECK:                       %13 = hls.dataflow.buffer {depth = 1 : i32, init_value = -24 : i8} : memref<16x14x14xi8, 7>
// CHECK:                       %14 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x16xi8, 7>
// CHECK:                       %15 = hls.dataflow.buffer {depth = 1 : i32, init_value = -24 : i8} : memref<16x14x14xi8, 7>
// CHECK:                       hls.dataflow.node(%arg30) -> (%15) [%arg25, %arg24, %arg27, %arg26, %arg23] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x28x28xi8, 12>) -> memref<16x14x14xi8, 7>[index, index, index, index, index] {
// CHECK:                       ^bb0(%arg32: memref<64x28x28xi8, 12>, %arg33: memref<16x14x14xi8, 7>, %arg34: index, %arg35: index, %arg36: index, %arg37: index, %arg38: index):
// CHECK:                         affine.for %arg39 = 0 to 16 {
// CHECK:                           affine.for %arg40 = 0 to 14 step 2 {
// CHECK:                             affine.for %arg41 = 0 to 14 step 2 {
// CHECK:                               %17 = affine.load %arg32[%arg39 + symbol(%arg34) * 16, %arg40 + symbol(%arg35) + symbol(%arg36) * 14 - 1, %arg41 + symbol(%arg37) + symbol(%arg38) * 14 - 1] : memref<64x28x28xi8, 12>
// CHECK:                               affine.store %17, %arg33[%arg39, %arg40, %arg41] : memref<16x14x14xi8, 7>
// CHECK:                               %18 = affine.load %arg32[%arg39 + symbol(%arg34) * 16, %arg40 + symbol(%arg35) + symbol(%arg36) * 14 - 1, %arg41 + symbol(%arg37) + symbol(%arg38) * 14] : memref<64x28x28xi8, 12>
// CHECK:                               affine.store %18, %arg33[%arg39, %arg40, %arg41 + 1] : memref<16x14x14xi8, 7>
// CHECK:                               %19 = affine.load %arg32[%arg39 + symbol(%arg34) * 16, %arg40 + symbol(%arg35) + symbol(%arg36) * 14, %arg41 + symbol(%arg37) + symbol(%arg38) * 14 - 1] : memref<64x28x28xi8, 12>
// CHECK:                               affine.store %19, %arg33[%arg39, %arg40 + 1, %arg41] : memref<16x14x14xi8, 7>
// CHECK:                               %20 = affine.load %arg32[%arg39 + symbol(%arg34) * 16, %arg40 + symbol(%arg35) + symbol(%arg36) * 14, %arg41 + symbol(%arg37) + symbol(%arg38) * 14] : memref<64x28x28xi8, 12>
// CHECK:                               affine.store %20, %arg33[%arg39, %arg40 + 1, %arg41 + 1] : memref<16x14x14xi8, 7>
// CHECK:                             } {parallel}
// CHECK:                           } {parallel}
// CHECK:                         } {parallel}
// CHECK:                       }
// CHECK:                       hls.dataflow.node(%arg29) -> (%14) [%arg31, %arg25, %arg24, %arg26] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x64x3x3xi8, 12>) -> memref<16x16xi8, 7>[index, index, index, index] {
// CHECK:                       ^bb0(%arg32: memref<64x64x3x3xi8, 12>, %arg33: memref<16x16xi8, 7>, %arg34: index, %arg35: index, %arg36: index, %arg37: index):
// CHECK:                         affine.for %arg38 = 0 to 16 {
// CHECK:                           affine.for %arg39 = 0 to 16 {
// CHECK:                             %17 = affine.load %arg32[%arg38 + symbol(%arg34) * 16, %arg39 + symbol(%arg35) * 16, symbol(%arg36), symbol(%arg37)] : memref<64x64x3x3xi8, 12>
...
// CHECK:                         } {parallel}
// CHECK:                       }
// CHECK:                       hls.dataflow.node(%arg28) -> (%13) [%arg31, %arg27, %arg23] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x28x28xi8, 12>) -> memref<16x14x14xi8, 7>[index, index, index] {
// CHECK:                       ^bb0(%arg32: memref<64x28x28xi8, 12>, %arg33: memref<16x14x14xi8, 7>, %arg34: index, %arg35: index, %arg36: index):
// CHECK:                         affine.for %arg37 = 0 to 16 {
// CHECK:                           affine.for %arg38 = 0 to 14 step 2 {
// CHECK:                             affine.for %arg39 = 0 to 14 step 2 {
...
// CHECK:                       }
// CHECK:                       %16 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, 7>
// CHECK:                       hls.dataflow.node(%15, %14, %13) -> (%16) {inputTaps = [0 : i32, 0 : i32, 0 : i32], level = 1 : i32} : (memref<16x14x14xi8, 7>, memref<16x16xi8, 7>, memref<16x14x14xi8, 7>) -> memref<16x14x14xi8, 7> {
// CHECK:                       ^bb0(%arg32: memref<16x14x14xi8, 7>, %arg33: memref<16x16xi8, 7>, %arg34: memref<16x14x14xi8, 7>, %arg35: memref<16x14x14xi8, 7>):
// CHECK:                         affine.for %arg36 = 0 to 16 {
// CHECK:                           affine.for %arg37 = 0 to 16 {
// CHECK:                             affine.for %arg38 = 0 to 14 step 2 {
// CHECK:                               affine.for %arg39 = 0 to 14 step 2 {
// CHECK:                                 %17 = affine.load %arg32[%arg36, %arg38, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                                 %18 = affine.load %arg33[%arg37, %arg36] : memref<16x16xi8, 7>
// CHECK:                                 %19 = affine.load %arg34[%arg37, %arg38, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                                 %20 = affine.load %arg35[%arg37, %arg38, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                                 %21 = hls.affine.select #set(%arg36) %19, %20 : i8
// CHECK:                                 %22 = arith.muli %17, %18 : i8
// CHECK:                                 %23 = arith.addi %21, %22 : i8
// CHECK:                                 affine.store %23, %arg35[%arg37, %arg38, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                                 %24 = affine.load %arg32[%arg36, %arg38, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %25 = affine.load %arg34[%arg37, %arg38, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %26 = affine.load %arg35[%arg37, %arg38, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %27 = hls.affine.select #set(%arg36) %25, %26 : i8
// CHECK:                                 %28 = arith.muli %24, %18 : i8
// CHECK:                                 %29 = arith.addi %27, %28 : i8
// CHECK:                                 affine.store %29, %arg35[%arg37, %arg38, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %30 = affine.load %arg32[%arg36, %arg38 + 1, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                                 %31 = affine.load %arg34[%arg37, %arg38 + 1, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                                 %32 = affine.load %arg35[%arg37, %arg38 + 1, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                                 %33 = hls.affine.select #set(%arg36) %31, %32 : i8
// CHECK:                                 %34 = arith.muli %30, %18 : i8
// CHECK:                                 %35 = arith.addi %33, %34 : i8
// CHECK:                                 affine.store %35, %arg35[%arg37, %arg38 + 1, %arg39] : memref<16x14x14xi8, 7>
// CHECK:                                 %36 = affine.load %arg32[%arg36, %arg38 + 1, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %37 = affine.load %arg34[%arg37, %arg38 + 1, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %38 = affine.load %arg35[%arg37, %arg38 + 1, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                                 %39 = hls.affine.select #set(%arg36) %37, %38 : i8
// CHECK:                                 %40 = arith.muli %36, %18 : i8
// CHECK:                                 %41 = arith.addi %39, %40 : i8
// CHECK:                                 affine.store %41, %arg35[%arg37, %arg38 + 1, %arg39 + 1] : memref<16x14x14xi8, 7>
// CHECK:                               } {parallel, point}
// CHECK:                             } {parallel, point}
// CHECK:                           } {parallel, point}
// CHECK:                         } {point}
// CHECK:                       }
// CHECK:                       hls.dataflow.node(%16) -> (%arg28) [%arg31, %arg27, %arg23] {inputTaps = [0 : i32], level = 0 : i32} : (memref<16x14x14xi8, 7>) -> memref<64x28x28xi8, 12>[index, index, index] {
// CHECK:                       ^bb0(%arg32: memref<16x14x14xi8, 7>, %arg33: memref<64x28x28xi8, 12>, %arg34: index, %arg35: index, %arg36: index):
// CHECK:                         affine.for %arg37 = 0 to 16 {
// CHECK:                           affine.for %arg38 = 0 to 14 step 2 {
// CHECK:                             affine.for %arg39 = 0 to 14 step 2 {
...
// CHECK:       hls.dataflow.node(%2, %1, %arg6, %8, %7) -> (%10, %9, %11) {inputTaps = [2 : i32, 2 : i32, 0 : i32, 0 : i32, 0 : i32], level = 2 : i32} : (!hls.stream<i1, 3>, memref<64x56x56xi8, 12>, memref<64x64xi8, 12>, !hls.stream<i1, 1>, memref<64x28x28xi8, 12>) -> (!hls.stream<i1, 1>, memref<64x28x28xi8, 12>, memref<64x28x28xi8, 12>) {
// CHECK:       ^bb0(%arg12: !hls.stream<i1, 3>, %arg13: memref<64x56x56xi8, 12>, %arg14: memref<64x64xi8, 12>, %arg15: !hls.stream<i1, 1>, %arg16: memref<64x28x28xi8, 12>, %arg17: !hls.stream<i1, 1>, %arg18: memref<64x28x28xi8, 12>, %arg19: memref<64x28x28xi8, 12>):
...
// CHECK:                 hls.dataflow.schedule legal(%arg22, %arg23, %arg14, %arg16, %arg13, %arg20, %arg18, %arg19, %arg21) : index, index, memref<64x64xi8, 12>, memref<64x28x28xi8, 12>, memref<64x56x56xi8, 12>, index, memref<64x28x28xi8, 12>, memref<64x28x28xi8, 12>, index {
// CHECK:                 ^bb0(%arg24: index, %arg25: index, %arg26: memref<64x64xi8, 12>, %arg27: memref<64x28x28xi8, 12>, %arg28: memref<64x56x56xi8, 12>, %arg29: index, %arg30: memref<64x28x28xi8, 12>, %arg31: memref<64x28x28xi8, 12>, %arg32: index):
// CHECK:                   %13 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, 7>
...
// CHECK:                   hls.dataflow.node(%arg28) -> (%17) [%arg29, %arg24, %arg25] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x56x56xi8, 12>) -> memref<16x14x14xi8, 7>[index, index, index] {
// CHECK:                   ^bb0(%arg33: memref<64x56x56xi8, 12>, %arg34: memref<16x14x14xi8, 7>, %arg35: index, %arg36: index, %arg37: index):
// CHECK:                     affine.for %arg38 = 0 to 16 {
// CHECK:                       affine.for %arg39 = 0 to 14 {
// CHECK:                         affine.for %arg40 = 0 to 14 {
// CHECK:                           %19 = affine.load %arg33[%arg38 + symbol(%arg35) * 16, %arg39 * 2 + symbol(%arg36) * 28, %arg40 * 2 + symbol(%arg37) * 28] : memref<64x56x56xi8, 12>
// CHECK:                           affine.store %19, %arg34[%arg38, %arg39, %arg40] : memref<16x14x14xi8, 7>
// CHECK:                         } {parallel}
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
// CHECK:                   }
// CHECK:                   hls.dataflow.node(%arg26) -> (%16) [%arg32, %arg29] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x64xi8, 12>) -> memref<16x16xi8, 7>[index, index] {
// CHECK:                   ^bb0(%arg33: memref<64x64xi8, 12>, %arg34: memref<16x16xi8, 7>, %arg35: index, %arg36: index):
// CHECK:                     affine.for %arg37 = 0 to 16 {
// CHECK:                       affine.for %arg38 = 0 to 16 {
// CHECK:                         %19 = affine.load %arg33[%arg37 + symbol(%arg35) * 16, %arg38 + symbol(%arg36) * 16] : memref<64x64xi8, 12>
// CHECK:                         affine.store %19, %arg34[%arg37, %arg38] : memref<16x16xi8, 7>
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
// CHECK:                   }
// CHECK:                   hls.dataflow.node(%arg31) -> (%15) [%arg32, %arg24, %arg25] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x28x28xi8, 12>) -> memref<16x14x14xi8, 7>[index, index, index] {
// CHECK:                   ^bb0(%arg33: memref<64x28x28xi8, 12>, %arg34: memref<16x14x14xi8, 7>, %arg35: index, %arg36: index, %arg37: index):
// CHECK:                     affine.for %arg38 = 0 to 16 {
// CHECK:                       affine.for %arg39 = 0 to 14 {
// CHECK:                         affine.for %arg40 = 0 to 14 {
// CHECK:                           %19 = affine.load %arg33[%arg38 + symbol(%arg35) * 16, %arg39 + symbol(%arg36) * 14, %arg40 + symbol(%arg37) * 14] : memref<64x28x28xi8, 12>
// CHECK:                           affine.store %19, %arg34[%arg38, %arg39, %arg40] : memref<16x14x14xi8, 7>
// CHECK:                         } {parallel}
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
// CHECK:                   }
// CHECK:                   hls.dataflow.node(%arg27) -> (%14) [%arg32, %arg24, %arg25] {inputTaps = [0 : i32], level = 2 : i32} : (memref<64x28x28xi8, 12>) -> memref<16x14x14xi8, 7>[index, index, index] {
// CHECK:                   ^bb0(%arg33: memref<64x28x28xi8, 12>, %arg34: memref<16x14x14xi8, 7>, %arg35: index, %arg36: index, %arg37: index):
// CHECK:                     affine.for %arg38 = 0 to 16 {
// CHECK:                       affine.for %arg39 = 0 to 14 {
// CHECK:                         affine.for %arg40 = 0 to 14 {
...
// CHECK:                   hls.dataflow.node(%14, %17, %16, %15) -> (%13, %18) [%arg29] {inputTaps = [0 : i32, 0 : i32, 0 : i32, 0 : i32], level = 1 : i32} : (memref<16x14x14xi8, 7>, memref<16x14x14xi8, 7>, memref<16x16xi8, 7>, memref<16x14x14xi8, 7>) -> (memref<16x14x14xi8, 7>, memref<16x14x14xi8, 7>)[index] {
// CHECK:                   ^bb0(%arg33: memref<16x14x14xi8, 7>, %arg34: memref<16x14x14xi8, 7>, %arg35: memref<16x16xi8, 7>, %arg36: memref<16x14x14xi8, 7>, %arg37: memref<16x14x14xi8, 7>, %arg38: memref<16x14x14xi8, 7>, %arg39: index):
// CHECK:                     %c-24_i8 = arith.constant -24 : i8
// CHECK:                     affine.for %arg40 = 0 to 16 {
// CHECK:                       affine.for %arg41 = 0 to 16 {
// CHECK:                         affine.for %arg42 = 0 to 14 {
// CHECK:                           affine.for %arg43 = 0 to 14 {
// CHECK:                             %19 = affine.load %arg34[%arg40, %arg42, %arg43] : memref<16x14x14xi8, 7>
// CHECK:                             %20 = affine.load %arg35[%arg41, %arg40] : memref<16x16xi8, 7>
// CHECK:                             %21 = affine.load %arg36[%arg41, %arg42, %arg43] : memref<16x14x14xi8, 7>
// CHECK:                             %22 = affine.load %arg38[%arg41, %arg42, %arg43] : memref<16x14x14xi8, 7>
// CHECK:                             %23 = hls.affine.select #set(%arg40) %21, %22 : i8
// CHECK:                             %24 = arith.muli %19, %20 : i8
// CHECK:                             %25 = arith.addi %23, %24 : i8
// CHECK:                             affine.store %25, %arg38[%arg41, %arg42, %arg43] : memref<16x14x14xi8, 7>
// CHECK:                             %26 = affine.load %arg33[%arg41, %arg42, %arg43] : memref<16x14x14xi8, 7>
...
// CHECK:                               affine.store %29, %arg37[%arg41, %arg42, %arg43] : memref<16x14x14xi8, 7>
// CHECK:                             }
// CHECK:                           } {parallel, point}
// CHECK:                         } {parallel, point}
// CHECK:                       } {parallel, point}
// CHECK:                     } {point}
// CHECK:                   }
// CHECK:                   hls.dataflow.node(%18) -> (%arg31) [%arg32, %arg24, %arg25] {inputTaps = [0 : i32], level = 0 : i32} : (memref<16x14x14xi8, 7>) -> memref<64x28x28xi8, 12>[index, index, index] {
// CHECK:                   ^bb0(%arg33: memref<16x14x14xi8, 7>, %arg34: memref<64x28x28xi8, 12>, %arg35: index, %arg36: index, %arg37: index):
// CHECK:                     affine.for %arg38 = 0 to 16 {
// CHECK:                       affine.for %arg39 = 0 to 14 {
// CHECK:                         affine.for %arg40 = 0 to 14 {
// CHECK:                           %19 = affine.load %arg33[%arg38, %arg39, %arg40] : memref<16x14x14xi8, 7>
// CHECK:                           affine.store %19, %arg34[%arg38 + symbol(%arg35) * 16, %arg39 + symbol(%arg36) * 14, %arg40 + symbol(%arg37) * 14] : memref<64x28x28xi8, 12>
// CHECK:                         } {parallel}
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
// CHECK:                   }
// CHECK:                   hls.dataflow.node(%13) -> (%arg30) [%arg32, %arg24, %arg25] {inputTaps = [0 : i32], level = 0 : i32} : (memref<16x14x14xi8, 7>) -> memref<64x28x28xi8, 12>[index, index, index] {
// CHECK:                   ^bb0(%arg33: memref<16x14x14xi8, 7>, %arg34: memref<64x28x28xi8, 12>, %arg35: index, %arg36: index, %arg37: index):
// CHECK:                     affine.for %arg38 = 0 to 16 {
// CHECK:                       affine.for %arg39 = 0 to 14 {
// CHECK:                         affine.for %arg40 = 0 to 14 {
...
// CHECK:       hls.dataflow.node(%10, %9) -> (%12) {inputTaps = [0 : i32, 0 : i32], level = 1 : i32} : (!hls.stream<i1, 1>, memref<64x28x28xi8, 12>) -> memref<64xi8, 7> {
// CHECK:       ^bb0(%arg12: !hls.stream<i1, 1>, %arg13: memref<64x28x28xi8, 12>, %arg14: memref<64xi8, 7>):
// CHECK:         hls.dataflow.stream_read %arg12 : (!hls.stream<i1, 1>) -> ()
// CHECK:         affine.for %arg15 = 0 to 2 {
// CHECK:           affine.for %arg16 = 0 to 2 {
// CHECK:             affine.for %arg17 = 0 to 4 {
// CHECK:               hls.dataflow.schedule legal(%arg13, %arg15, %arg14, %arg16, %arg17) : memref<64x28x28xi8, 12>, index, memref<64xi8, 7>, index, index {
// CHECK:               ^bb0(%arg18: memref<64x28x28xi8, 12>, %arg19: index, %arg20: memref<64xi8, 7>, %arg21: index, %arg22: index):
// CHECK:                 %13 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, 7>
// CHECK:                 hls.dataflow.node(%arg18) -> (%13) [%arg22, %arg19, %arg21] {inputTaps = [0 : i32], level = 1 : i32} : (memref<64x28x28xi8, 12>) -> memref<16x14x14xi8, 7>[index, index, index] {
// CHECK:                 ^bb0(%arg23: memref<64x28x28xi8, 12>, %arg24: memref<16x14x14xi8, 7>, %arg25: index, %arg26: index, %arg27: index):
// CHECK:                   affine.for %arg28 = 0 to 16 {
// CHECK:                     affine.for %arg29 = 0 to 14 {
// CHECK:                       affine.for %arg30 = 0 to 14 {
// CHECK:                         %14 = affine.load %arg23[%arg28 + symbol(%arg25) * 16, %arg29 + symbol(%arg26) * 14, %arg30 + symbol(%arg27) * 14] : memref<64x28x28xi8, 12>
// CHECK:                         affine.store %14, %arg24[%arg28, %arg29, %arg30] : memref<16x14x14xi8, 7>
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
// CHECK:                   } {parallel}
// CHECK:                 }
// CHECK:                 hls.dataflow.node(%13) -> (%arg20) [%arg22, %arg19, %arg21] {inputTaps = [0 : i32], level = 0 : i32} : (memref<16x14x14xi8, 7>) -> memref<64xi8, 7>[index, index, index] {
// CHECK:                 ^bb0(%arg23: memref<16x14x14xi8, 7>, %arg24: memref<64xi8, 7>, %arg25: index, %arg26: index, %arg27: index):
// CHECK:                   %c-24_i8 = arith.constant -24 : i8
// CHECK:                   affine.for %arg28 = 0 to 14 {
// CHECK:                     affine.for %arg29 = 0 to 14 {
// CHECK:                       affine.for %arg30 = 0 to 16 {
// CHECK:                         %14 = affine.load %arg23[%arg30, %arg28, %arg29] : memref<16x14x14xi8, 7>
// CHECK:                         %15 = affine.load %arg24[%arg30 + symbol(%arg25) * 16] : memref<64xi8, 7>
...
// CHECK:                         affine.store %18, %arg24[%arg30 + symbol(%arg25) * 16] : memref<64xi8, 7>
// CHECK:                       } {parallel, point}
// CHECK:                     } {point}
// CHECK:                   } {point}
// CHECK:                 }
...
// CHECK:         }
// CHECK:       }
// CHECK:       hls.dataflow.node(%12, %arg9) -> (%arg7) {inputTaps = [0 : i32, 0 : i32], level = 0 : i32} : (memref<64xi8, 7>, memref<1000x64xi8, 12>) -> memref<1000xi8, 12> {
...
// CHECK:               %13 = hls.dataflow.buffer {depth = 1 : i32} : memref<10x16xi8, 7>
// CHECK:               %14 = hls.dataflow.buffer {depth = 1 : i32} : memref<10xi8, 7>
// CHECK:               hls.dataflow.node(%arg21) -> (%14) [%arg18] {inputTaps = [0 : i32], level = 2 : i32} : (memref<1000xi8, 12>) -> memref<10xi8, 7>[index] {
// CHECK:               ^bb0(%arg22: memref<1000xi8, 12>, %arg23: memref<10xi8, 7>, %arg24: index):
// CHECK:                 affine.for %arg25 = 0 to 10 {
// CHECK:                   %16 = affine.load %arg22[%arg25 + symbol(%arg24) * 10] : memref<1000xi8, 12>
// CHECK:                   affine.store %16, %arg23[%arg25] : memref<10xi8, 7>
// CHECK:                 } {parallel}
// CHECK:               }
// CHECK:               hls.dataflow.node(%arg20) -> (%13) [%arg18, %arg17] {inputTaps = [0 : i32], level = 2 : i32} : (memref<1000x64xi8, 12>) -> memref<10x16xi8, 7>[index, index] {
...
// CHECK:                     %16 = affine.load %arg22[%arg26 + symbol(%arg24) * 10, %arg27 + symbol(%arg25) * 16] : memref<1000x64xi8, 12>
// CHECK:                     affine.store %16, %arg23[%arg26, %arg27] : memref<10x16xi8, 7>
// CHECK:                   } {parallel}
// CHECK:                 } {parallel}
// CHECK:               }
// CHECK:               %15 = hls.dataflow.buffer {depth = 1 : i32} : memref<10xi8, 7>
// CHECK:               hls.dataflow.node(%arg19, %13, %14) -> (%15) [%arg17] {inputTaps = [0 : i32, 0 : i32, 0 : i32], level = 1 : i32} : (memref<64xi8, 7>, memref<10x16xi8, 7>, memref<10xi8, 7>) -> memref<10xi8, 7>[index] {
...
// CHECK:                     %16 = affine.load %arg24[%arg28] : memref<10xi8, 7>
// CHECK:                     %17 = affine.load %arg25[%arg28] : memref<10xi8, 7>
// CHECK:                     %18 = hls.affine.select #set(%arg27) %16, %17 : i8
// CHECK:                     %19 = hls.affine.select #set4(%arg27, %arg26) %c-24_i8, %18 : i8
// CHECK:                     %20 = affine.load %arg22[%arg27 + symbol(%arg26) * 16] : memref<64xi8, 7>
// CHECK:                     %21 = affine.load %arg23[%arg28, %arg27] : memref<10x16xi8, 7>
// CHECK:                     %22 = arith.muli %20, %21 : i8
// CHECK:                     %23 = arith.addi %19, %22 : i8
// CHECK:                     affine.store %23, %arg25[%arg28] : memref<10xi8, 7>
// CHECK:                   } {parallel, point}
// CHECK:                 } {point}
// CHECK:               }
// CHECK:               hls.dataflow.node(%15) -> (%arg21) [%arg18] {inputTaps = [0 : i32], level = 0 : i32} : (memref<10xi8, 7>) -> memref<1000xi8, 12>[index] {
// CHECK:               ^bb0(%arg22: memref<10xi8, 7>, %arg23: memref<1000xi8, 12>, %arg24: index):
// CHECK:                 affine.for %arg25 = 0 to 10 {
// CHECK:                   %16 = affine.load %arg22[%arg25] : memref<10xi8, 7>
// CHECK:                   affine.store %16, %arg23[%arg25 + symbol(%arg24) * 10] : memref<1000xi8, 12>
// CHECK:                 } {parallel}
// CHECK:               }
// CHECK:             }
// CHECK:           } {parallel}
                          ...
                          affine.for %arg38 = 0 to 16 {
                            affine.for %arg39 = 0 to 14 step 2 {
                              affine.for %arg40 = 0 to 14 step 2 {
                                ...
                                %22 = affine.load %arg32[%arg38, %arg39, %arg40 + 1] : memref<16x14x14xi8, 7>
                                %23 = affine.load %arg33[%arg38, %arg39, %arg40 + 1] : memref<16x14x14xi8, 7>
                                ...
                                affine.store %29, %arg33[%arg38, %arg39, %arg40 + 1] : memref<16x14x14xi8, 7>
                                %30 = affine.load %arg30[%arg37, %arg39 + 1, %arg40] : memref<16x14x14xi8, 7>
                                %31 = affine.load %arg32[%arg38, %arg39 + 1, %arg40] : memref<16x14x14xi8, 7>
                                %32 = affine.load %arg33[%arg38, %arg39 + 1, %arg40] : memref<16x14x14xi8, 7>
                                ...
                                affine.store %38, %arg33[%arg38, %arg39 + 1, %arg40] : memref<16x14x14xi8, 7>
                                %39 = affine.load %arg30[%arg37, %arg39 + 1, %arg40 + 1] : memref<16x14x14xi8, 7>
                                %40 = affine.load %arg32[%arg38, %arg39 + 1, %arg40 + 1] : memref<16x14x14xi8, 7>
                                %41 = affine.load %arg33[%arg38, %arg39 + 1, %arg40 + 1] : memref<16x14x14xi8, 7>
                                ...
                                affine.store %47, %arg33[%arg38, %arg39 + 1, %arg40 + 1] : memref<16x14x14xi8, 7>
                              } {parallel, point}
                            } {parallel, point}
                          } {parallel, point}
                        } {point}
                          ...
                          affine.for %arg35 = 0 to 16 {
                            affine.for %arg36 = 0 to 14 step 2 {
                              affine.for %arg37 = 0 to 14 step 2 {
                                ...
                                %19 = affine.load %arg32[%arg35, %arg36, %arg37 + 1] : memref<16x14x14xi8, 7>
                                %20 = affine.load %arg33[%arg35, %arg36, %arg37 + 1] : memref<16x14x14xi8, 7>
                                %21 = hls.affine.select #set(%arg34) %19, %20 : i8
                                %22 = arith.muli %18, %12 : i8
                                %23 = arith.addi %21, %22 : i8
                                affine.store %23, %arg33[%arg35, %arg36, %arg37 + 1] : memref<16x14x14xi8, 7>
                                %24 = affine.load %arg30[%arg34, %arg36 + 1, %arg37] : memref<16x14x14xi8, 7>
                                %25 = affine.load %arg32[%arg35, %arg36 + 1, %arg37] : memref<16x14x14xi8, 7>
                                %26 = affine.load %arg33[%arg35, %arg36 + 1, %arg37] : memref<16x14x14xi8, 7>
                                %27 = hls.affine.select #set(%arg34) %25, %26 : i8
                                %28 = arith.muli %24, %12 : i8
                                %29 = arith.addi %27, %28 : i8
                                affine.store %29, %arg33[%arg35, %arg36 + 1, %arg37] : memref<16x14x14xi8, 7>
                                %30 = affine.load %arg30[%arg34, %arg36 + 1, %arg37 + 1] : memref<16x14x14xi8, 7>
                                %31 = affine.load %arg32[%arg35, %arg36 + 1, %arg37 + 1] : memref<16x14x14xi8, 7>
                                %32 = affine.load %arg33[%arg35, %arg36 + 1, %arg37 + 1] : memref<16x14x14xi8, 7>
                                %33 = hls.affine.select #set(%arg34) %31, %32 : i8
                                %34 = arith.muli %30, %12 : i8
                                %35 = arith.addi %33, %34 : i8
                                affine.store %35, %arg33[%arg35, %arg36 + 1, %arg37 + 1] : memref<16x14x14xi8, 7>
                              } {parallel, point}
                            } {parallel, point}
                          } {parallel, point}
                        } {point}
