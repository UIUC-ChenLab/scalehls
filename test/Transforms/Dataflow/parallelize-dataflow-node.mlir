...
// CHECK:                                 %13 = affine.load %arg30[%arg37, %11, %12] : memref<16x14x14xi8, 7>
// CHECK:                                 %14 = affine.load %arg31[%arg38, %arg37] : memref<16x16xi8, 7>
// CHECK:                                 %15 = affine.load %arg32[%arg38, %11, %12] : memref<16x14x14xi8, 7>
// CHECK:                                 %16 = affine.load %arg33[%arg38, %11, %12] : memref<16x14x14xi8, 7>
...
// CHECK:                                 affine.store %22, %arg33[%arg38, %11, %12] : memref<16x14x14xi8, 7>
// CHECK:                                 %23 = affine.apply #map1(%c0_0)
// CHECK:                                 %24 = affine.apply #map(%arg40, %23)
// CHECK:                                 %25 = affine.load %arg30[%arg37, %11, %24] : memref<16x14x14xi8, 7>
// CHECK:                                 %26 = affine.load %arg31[%arg38, %arg37] : memref<16x16xi8, 7>
// CHECK:                                 %27 = affine.load %arg32[%arg38, %11, %24] : memref<16x14x14xi8, 7>
// CHECK:                                 %28 = affine.load %arg33[%arg38, %11, %24] : memref<16x14x14xi8, 7>
...
// CHECK:                                 affine.store %34, %arg33[%arg38, %11, %24] : memref<16x14x14xi8, 7>
// CHECK:                                 %35 = affine.apply #map1(%c0)
// CHECK:                                 %36 = affine.apply #map(%arg39, %35)
// CHECK:                                 %37 = affine.apply #map(%arg40, %c0_0)
// CHECK:                                 %38 = affine.load %arg30[%arg37, %36, %37] : memref<16x14x14xi8, 7>
// CHECK:                                 %39 = affine.load %arg31[%arg38, %arg37] : memref<16x16xi8, 7>
// CHECK:                                 %40 = affine.load %arg32[%arg38, %36, %37] : memref<16x14x14xi8, 7>
// CHECK:                                 %41 = affine.load %arg33[%arg38, %36, %37] : memref<16x14x14xi8, 7>
...
// CHECK:                                 affine.store %47, %arg33[%arg38, %36, %37] : memref<16x14x14xi8, 7>
// CHECK:                                 %48 = affine.apply #map1(%c0_0)
// CHECK:                                 %49 = affine.apply #map(%arg40, %48)
// CHECK:                                 %50 = affine.load %arg30[%arg37, %36, %49] : memref<16x14x14xi8, 7>
// CHECK:                                 %51 = affine.load %arg31[%arg38, %arg37] : memref<16x16xi8, 7>
// CHECK:                                 %52 = affine.load %arg32[%arg38, %36, %49] : memref<16x14x14xi8, 7>
// CHECK:                                 %53 = affine.load %arg33[%arg38, %36, %49] : memref<16x14x14xi8, 7>
...
// CHECK:                                 affine.store %59, %arg33[%arg38, %36, %49] : memref<16x14x14xi8, 7>
// CHECK:                               } {parallel, point}
// CHECK:                             } {parallel, point}
// CHECK:                           } {parallel, point}
// CHECK:                         } {point}
...
// CHECK:                                 %13 = affine.load %arg30[%arg34, %11, %12] : memref<16x14x14xi8, 7>
// CHECK:                                 %14 = affine.load %arg31[%arg35, %arg34] : memref<16x16xi8, 7>
// CHECK:                                 %15 = affine.load %arg32[%arg35, %11, %12] : memref<16x14x14xi8, 7>
// CHECK:                                 %16 = affine.load %arg33[%arg35, %11, %12] : memref<16x14x14xi8, 7>
// CHECK:                                 %17 = hls.affine.select #set(%arg34) %15, %16 : i8
// CHECK:                                 %18 = arith.muli %13, %14 : i8
// CHECK:                                 %19 = arith.addi %17, %18 : i8
// CHECK:                                 affine.store %19, %arg33[%arg35, %11, %12] : memref<16x14x14xi8, 7>
// CHECK:                                 %20 = affine.apply #map1(%c0_0)
// CHECK:                                 %21 = affine.apply #map(%arg37, %20)
// CHECK:                                 %22 = affine.load %arg30[%arg34, %11, %21] : memref<16x14x14xi8, 7>
// CHECK:                                 %23 = affine.load %arg31[%arg35, %arg34] : memref<16x16xi8, 7>
// CHECK:                                 %24 = affine.load %arg32[%arg35, %11, %21] : memref<16x14x14xi8, 7>
// CHECK:                                 %25 = affine.load %arg33[%arg35, %11, %21] : memref<16x14x14xi8, 7>
// CHECK:                                 %26 = hls.affine.select #set(%arg34) %24, %25 : i8
// CHECK:                                 %27 = arith.muli %22, %23 : i8
// CHECK:                                 %28 = arith.addi %26, %27 : i8
// CHECK:                                 affine.store %28, %arg33[%arg35, %11, %21] : memref<16x14x14xi8, 7>
// CHECK:                                 %29 = affine.apply #map1(%c0)
// CHECK:                                 %30 = affine.apply #map(%arg36, %29)
// CHECK:                                 %31 = affine.apply #map(%arg37, %c0_0)
// CHECK:                                 %32 = affine.load %arg30[%arg34, %30, %31] : memref<16x14x14xi8, 7>
// CHECK:                                 %33 = affine.load %arg31[%arg35, %arg34] : memref<16x16xi8, 7>
// CHECK:                                 %34 = affine.load %arg32[%arg35, %30, %31] : memref<16x14x14xi8, 7>
// CHECK:                                 %35 = affine.load %arg33[%arg35, %30, %31] : memref<16x14x14xi8, 7>
// CHECK:                                 %36 = hls.affine.select #set(%arg34) %34, %35 : i8
// CHECK:                                 %37 = arith.muli %32, %33 : i8
// CHECK:                                 %38 = arith.addi %36, %37 : i8
// CHECK:                                 affine.store %38, %arg33[%arg35, %30, %31] : memref<16x14x14xi8, 7>
// CHECK:                                 %39 = affine.apply #map1(%c0_0)
// CHECK:                                 %40 = affine.apply #map(%arg37, %39)
// CHECK:                                 %41 = affine.load %arg30[%arg34, %30, %40] : memref<16x14x14xi8, 7>
// CHECK:                                 %42 = affine.load %arg31[%arg35, %arg34] : memref<16x16xi8, 7>
// CHECK:                                 %43 = affine.load %arg32[%arg35, %30, %40] : memref<16x14x14xi8, 7>
// CHECK:                                 %44 = affine.load %arg33[%arg35, %30, %40] : memref<16x14x14xi8, 7>
// CHECK:                                 %45 = hls.affine.select #set(%arg34) %43, %44 : i8
// CHECK:                                 %46 = arith.muli %41, %42 : i8
// CHECK:                                 %47 = arith.addi %45, %46 : i8
// CHECK:                                 affine.store %47, %arg33[%arg35, %30, %40] : memref<16x14x14xi8, 7>
// CHECK:                               } {parallel, point}
// CHECK:                             } {parallel, point}
// CHECK:                           } {parallel, point}
// CHECK:                         } {point}
