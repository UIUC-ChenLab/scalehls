// RUN: scalehls-opt -scalehls-balance-dataflow-node %s | FileCheck %s
...
// CHECK:                         %9 = affine.load %arg20[%arg25 + %arg22 * 16, %arg26 + %arg23 * 14, %arg27 + %arg24 * 14] : memref<64x56x56xi8, #hls.mem<dram>>
...
// CHECK:                         affine.store %9, %arg21[%arg22, %arg23, %arg24] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                         %10 = affine.load %arg21[%arg22, %arg23, %arg24] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                         %11 = arith.cmpi ugt, %10, %c-24_i8 : i8
// CHECK:                         %12 = arith.select %11, %10, %c-24_i8 : i8
// CHECK:                         affine.store %12, %arg21[%arg22, %arg23, %arg24] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
...
// CHECK:                         affine.store %9, %arg21[%arg25 + %arg22 * 16, %arg26 + %arg23 * 14, %arg27 + %arg24 * 14] : memref<64x56x56xi8, #hls.mem<dram>>
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
// CHECK:                   } {parallel}
// CHECK:                 }
...
// CHECK:         memref.copy %arg12, %arg13 : memref<64x56x56xi8, #hls.mem<dram>> to memref<64x56x56xi8, #hls.mem<dram>>
// CHECK:         memref.copy %arg12, %arg14 : memref<64x56x56xi8, #hls.mem<dram>> to memref<64x56x56xi8, #hls.mem<dram>>
// CHECK:       }
...
// CHECK:                               %11 = affine.load %arg30[%arg37 + %arg32 * 16, %arg38 * 2 + %arg33 + %arg34 * 28 - 1, %arg39 * 2 + %arg35 + %arg36 * 28 - 1] : memref<64x56x56xi8, #hls.mem<dram>>
...
// CHECK:                           affine.for %arg37 = 0 to 16 {
// CHECK:                             %11 = affine.load %arg30[%arg36 + %arg32 * 16, %arg37 + %arg33 * 16, %arg34, %arg35] : memref<64x64x3x3xi8, #hls.mem<dram>>
...
// CHECK:                               %11 = affine.load %arg30[%arg35 + %arg32 * 16, %arg36 + %arg33 * 14, %arg37 + %arg34 * 14] : memref<64x28x28xi8, #hls.mem<dram>>
...
// CHECK:                                 %11 = affine.load %arg30[%arg37, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                                 %12 = affine.load %arg31[%arg38, %arg37] : memref<16x16xi8, #hls.mem<bram_t2p>>
// CHECK:                                 %13 = affine.load %arg32[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                                 affine.if #set(%arg37) {
// CHECK:                                   affine.store %13, %arg33[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                                 }
// CHECK:                                 %14 = affine.load %arg33[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
...
// CHECK:                                 affine.store %19, %arg33[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                               } {parallel, point}
// CHECK:                             } {parallel, point}
// CHECK:                           } {parallel, point}
// CHECK:                         } {point}
...
// CHECK:                               affine.store %11, %arg31[%arg35 + %arg32 * 16, %arg36 + %arg33 * 14, %arg37 + %arg34 * 14] : memref<64x28x28xi8, #hls.mem<dram>>
// CHECK:                             } {parallel}
// CHECK:                           } {parallel}
// CHECK:                         } {parallel}
// CHECK:                       }
...
// CHECK:                           affine.for %arg38 = 0 to 14 {
// CHECK:                             affine.for %arg39 = 0 to 14 {
// CHECK:                               %11 = affine.load %arg30[%arg37 + %arg32 * 16, %arg38 + %arg33 + %arg34 * 14 - 1, %arg39 + %arg35 + %arg36 * 14 - 1] : memref<64x28x28xi8, #hls.mem<dram>>
// CHECK:                               affine.store %11, %arg31[%arg37, %arg38, %arg39] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                             } {parallel}
// CHECK:                           } {parallel}
// CHECK:                         } {parallel}
...
// CHECK:                             affine.for %arg36 = 0 to 14 {
// CHECK:                               affine.for %arg37 = 0 to 14 {
// CHECK:                                 %11 = affine.load %arg30[%arg34, %arg36, %arg37] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                                 %12 = affine.load %arg31[%arg35, %arg34] : memref<16x16xi8, #hls.mem<bram_t2p>>
// CHECK:                                 %13 = affine.load %arg32[%arg35, %arg36, %arg37] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                                 affine.if #set(%arg34) {
// CHECK:                                   affine.store %13, %arg33[%arg35, %arg36, %arg37] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                                 }
// CHECK:                                 %14 = affine.load %arg33[%arg35, %arg36, %arg37] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                                 %15 = arith.muli %11, %12 : i8
// CHECK:                                 %16 = arith.addi %14, %15 : i8
// CHECK:                                 affine.store %16, %arg33[%arg35, %arg36, %arg37] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                               } {parallel, point}
// CHECK:                             } {parallel, point}
// CHECK:                           } {parallel, point}
// CHECK:                         } {point}
...
// CHECK:                       affine.for %arg36 = 0 to 14 {
// CHECK:                         affine.for %arg37 = 0 to 14 {
// CHECK:                           %13 = affine.load %arg30[%arg35 + %arg32 * 16, %arg36 * 2 + %arg33 * 28, %arg37 * 2 + %arg34 * 28] : memref<64x56x56xi8, #hls.mem<dram>>
...
// CHECK:                     affine.for %arg34 = 0 to 16 {
// CHECK:                       affine.for %arg35 = 0 to 16 {
// CHECK:                         %13 = affine.load %arg30[%arg34 + %arg32 * 16, %arg35 + %arg33 * 16] : memref<64x64xi8, #hls.mem<dram>>
...
// CHECK:                       affine.for %arg36 = 0 to 14 {
// CHECK:                         affine.for %arg37 = 0 to 14 {
// CHECK:                           %13 = affine.load %arg30[%arg35 + %arg32 * 16, %arg36 + %arg33 * 14, %arg37 + %arg34 * 14] : memref<64x28x28xi8, #hls.mem<dram>>
// CHECK:                           affine.store %13, %arg31[%arg35, %arg36, %arg37] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                         } {parallel}
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
...
// CHECK:                             affine.if #set(%arg37) {
// CHECK:                               affine.store %15, %arg35[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                             }
...
// CHECK:                             affine.store %18, %arg35[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                             %19 = affine.load %arg30[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
...
// CHECK:                               affine.store %22, %arg34[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK:                             }
// CHECK:                           } {parallel, point}
// CHECK:                         } {parallel, point}
// CHECK:                       } {parallel, point}
...
// CHECK:                           affine.store %13, %arg31[%arg35 + %arg32 * 16, %arg36 + %arg33 * 14, %arg37 + %arg34 * 14] : memref<64x28x28xi8, #hls.mem<dram>>
// CHECK:                         } {parallel}
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
// CHECK:                   }
...
// CHECK:                         %8 = affine.load %arg22[%arg27 + %arg24 * 16, %arg28 + %arg25 * 14, %arg29 + %arg26 * 14] : memref<64x28x28xi8, #hls.mem<dram>>
...
// CHECK:                         %9 = affine.load %arg23[%arg29 + %arg24 * 16] : memref<64xi8, #hls.mem<bram_t2p>>
...
// CHECK:                         affine.store %12, %arg23[%arg29 + %arg24 * 16] : memref<64xi8, #hls.mem<bram_t2p>>
// CHECK:                       } {parallel, point}
// CHECK:                     } {point}
// CHECK:                   } {point}
// CHECK:                 }
...
// CHECK:                   %10 = affine.load %arg22[%arg25 + %arg24 * 10] : memref<1000xi8, #hls.mem<dram>>
...
// CHECK:                   affine.for %arg27 = 0 to 16 {
// CHECK:                     %10 = affine.load %arg22[%arg26 + %arg24 * 10, %arg27 + %arg25 * 16] : memref<1000x64xi8, #hls.mem<dram>>
...
// CHECK:                       affine.store %10, %arg25[%arg28] : memref<10xi8, #hls.mem<bram_t2p>>
// CHECK:                     }
// CHECK:                     %11 = affine.load %arg25[%arg28] : memref<10xi8, #hls.mem<bram_t2p>>
// CHECK:                     %12 = hls.affine.select #set4(%arg27, %arg26) %c-24_i8, %11 : i8
// CHECK:                     %13 = affine.load %arg22[%arg27 + %arg26 * 16] : memref<64xi8, #hls.mem<bram_t2p>>
// CHECK:                     %14 = affine.load %arg23[%arg28, %arg27] : memref<10x16xi8, #hls.mem<bram_t2p>>
// CHECK:                     %15 = arith.muli %13, %14 : i8
// CHECK:                     %16 = arith.addi %12, %15 : i8
// CHECK:                     affine.store %16, %arg25[%arg28] : memref<10xi8, #hls.mem<bram_t2p>>
// CHECK:                   } {parallel, point}
// CHECK:                 } {point}
// CHECK:               }
...
// CHECK:                   affine.store %10, %arg23[%arg25 + %arg24 * 10] : memref<1000xi8, #hls.mem<dram>>
// CHECK:                 } {parallel}
// CHECK:               }
// CHECK:             }
// CHECK:           } {parallel}
...
module attributes {torch.debug_module_name = "ResNet"} {
  func.func @forward(%arg0: memref<64x56x56xi8, #hls.mem<dram>>, %arg1: memref<1000x64xi8, #hls.mem<dram>>, %arg2: memref<64x64xi8, #hls.mem<dram>>, %arg3: memref<64x64x3x3xi8, #hls.mem<dram>>, %arg4: memref<64x64x3x3xi8, #hls.mem<dram>>, %arg5: memref<1000xi8, #hls.mem<dram>>) attributes {top_func} {
    ...
    ^bb0(%arg6: memref<64x64xi8, #hls.mem<dram>>, %arg7: memref<1000xi8, #hls.mem<dram>>, %arg8: memref<64x64x3x3xi8, #hls.mem<dram>>, %arg9: memref<1000x64xi8, #hls.mem<dram>>, %arg10: memref<64x56x56xi8, #hls.mem<dram>>, %arg11: memref<64x64x3x3xi8, #hls.mem<dram>>):
                  ...
                  affine.for %arg25 = 0 to 16 {
                    affine.for %arg26 = 0 to 14 {
                      affine.for %arg27 = 0 to 14 {
                        %9 = affine.load %arg20[%arg25 + %arg22 * 16, %arg26 + %arg23 * 14, %arg27 + %arg24 * 14] : memref<64x56x56xi8, #hls.mem<dram>>
                  ...
                  affine.for %arg22 = 0 to 16 {
                    affine.for %arg23 = 0 to 14 {
                      affine.for %arg24 = 0 to 14 {
                        ...
                        affine.store %9, %arg21[%arg22, %arg23, %arg24] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                        %10 = affine.load %arg21[%arg22, %arg23, %arg24] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                        %11 = arith.cmpi ugt, %10, %c-24_i8 : i8
                        %12 = arith.select %11, %10, %c-24_i8 : i8
                        affine.store %12, %arg21[%arg22, %arg23, %arg24] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                      } {parallel, point}
                    } {parallel, point}
                  } {parallel, point}
                }
                  ...
                  affine.for %arg25 = 0 to 16 {
                    affine.for %arg26 = 0 to 14 {
                      affine.for %arg27 = 0 to 14 {
                        ...
                        affine.store %9, %arg21[%arg25 + %arg22 * 16, %arg26 + %arg23 * 14, %arg27 + %arg24 * 14] : memref<64x56x56xi8, #hls.mem<dram>>
                      } {parallel}
                    } {parallel}
                  } {parallel}
                }
      ...
      %0 = hls.dataflow.buffer {depth = 1 : i32} : memref<64x56x56xi8, #hls.mem<dram>>
      ...
      ^bb0(%arg12: memref<64x56x56xi8, #hls.mem<dram>>, %arg13: memref<64x56x56xi8, #hls.mem<dram>>, %arg14: memref<64x56x56xi8, #hls.mem<dram>>):
        memref.copy %arg12, %arg13 : memref<64x56x56xi8, #hls.mem<dram>> to memref<64x56x56xi8, #hls.mem<dram>>
        memref.copy %arg12, %arg14 : memref<64x56x56xi8, #hls.mem<dram>> to memref<64x56x56xi8, #hls.mem<dram>>
      }
                    ...
                    ^bb0(%arg21: index, %arg22: memref<64x28x28xi8, #hls.mem<dram>>, %arg23: index, %arg24: index, %arg25: index, %arg26: memref<64x56x56xi8, #hls.mem<dram>>, %arg27: index, %arg28: memref<64x64x3x3xi8, #hls.mem<dram>>, %arg29: index):
                        ...
                        affine.for %arg37 = 0 to 16 {
                          affine.for %arg38 = 0 to 14 {
                            affine.for %arg39 = 0 to 14 {
                              %11 = affine.load %arg30[%arg37 + %arg32 * 16, %arg38 * 2 + %arg33 + %arg34 * 28 - 1, %arg39 * 2 + %arg35 + %arg36 * 28 - 1] : memref<64x56x56xi8, #hls.mem<dram>>
                      ...
                      ^bb0(%arg30: memref<64x64x3x3xi8, #hls.mem<dram>>, %arg31: memref<16x16xi8, #hls.mem<bram_t2p>>, %arg32: index, %arg33: index, %arg34: index, %arg35: index):
                        affine.for %arg36 = 0 to 16 {
                          affine.for %arg37 = 0 to 16 {
                            %11 = affine.load %arg30[%arg36 + %arg32 * 16, %arg37 + %arg33 * 16, %arg34, %arg35] : memref<64x64x3x3xi8, #hls.mem<dram>>
                        ...
                        affine.for %arg35 = 0 to 16 {
                          affine.for %arg36 = 0 to 14 {
                            affine.for %arg37 = 0 to 14 {
                              %11 = affine.load %arg30[%arg35 + %arg32 * 16, %arg36 + %arg33 * 14, %arg37 + %arg34 * 14] : memref<64x28x28xi8, #hls.mem<dram>>
                          ...
                          affine.for %arg38 = 0 to 16 {
                            affine.for %arg39 = 0 to 14 {
                              affine.for %arg40 = 0 to 14 {
                                ...
                                affine.if #set(%arg37) {
                                  affine.store %13, %arg33[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                                }
                                ...
                                %19 = hls.affine.select #set1(%arg36, %arg34, %arg37, %arg35) %18, %16 : i8
                                affine.store %19, %arg33[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                              } {parallel, point}
                            } {parallel, point}
                          } {parallel, point}
                        } {point}
                        ...
                        affine.for %arg35 = 0 to 16 {
                          affine.for %arg36 = 0 to 14 {
                            affine.for %arg37 = 0 to 14 {
                              ...
                              affine.store %11, %arg31[%arg35 + %arg32 * 16, %arg36 + %arg33 * 14, %arg37 + %arg34 * 14] : memref<64x28x28xi8, #hls.mem<dram>>
                            } {parallel}
                          } {parallel}
                        } {parallel}
                      }
                    ...
                    ^bb0(%arg21: index, %arg22: index, %arg23: index, %arg24: index, %arg25: index, %arg26: memref<64x28x28xi8, #hls.mem<dram>>, %arg27: memref<64x64x3x3xi8, #hls.mem<dram>>, %arg28: memref<64x28x28xi8, #hls.mem<dram>>, %arg29: index):
                      ...
                      ^bb0(%arg30: memref<64x28x28xi8, #hls.mem<dram>>, %arg31: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg32: index, %arg33: index, %arg34: index, %arg35: index, %arg36: index):
                        affine.for %arg37 = 0 to 16 {
                          affine.for %arg38 = 0 to 14 {
                            affine.for %arg39 = 0 to 14 {
                              %11 = affine.load %arg30[%arg37 + %arg32 * 16, %arg38 + %arg33 + %arg34 * 14 - 1, %arg39 + %arg35 + %arg36 * 14 - 1] : memref<64x28x28xi8, #hls.mem<dram>>
                              affine.store %11, %arg31[%arg37, %arg38, %arg39] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                            } {parallel}
                          } {parallel}
                        } {parallel}
                          ...
                          affine.for %arg35 = 0 to 16 {
                            affine.for %arg36 = 0 to 14 {
                              affine.for %arg37 = 0 to 14 {
                                ...
                                affine.if #set(%arg34) {
                                  affine.store %13, %arg33[%arg35, %arg36, %arg37] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                                }
                                %14 = affine.load %arg33[%arg35, %arg36, %arg37] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                                %15 = arith.muli %11, %12 : i8
                                %16 = arith.addi %14, %15 : i8
                                affine.store %16, %arg33[%arg35, %arg36, %arg37] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                              } {parallel, point}
                            } {parallel, point}
                          } {parallel, point}
                        } {point}
      ...
      hls.dataflow.node(%0, %arg6, %3) -> (%4, %5) {inputTaps = [0 : i32, 0 : i32, 0 : i32], level = 2 : i32} : (memref<64x56x56xi8, #hls.mem<dram>>, memref<64x64xi8, #hls.mem<dram>>, memref<64x28x28xi8, #hls.mem<dram>>) -> (memref<64x28x28xi8, #hls.mem<dram>>, memref<64x28x28xi8, #hls.mem<dram>>) {
                ...
                ^bb0(%arg21: index, %arg22: index, %arg23: memref<64x64xi8, #hls.mem<dram>>, %arg24: memref<64x28x28xi8, #hls.mem<dram>>, %arg25: memref<64x56x56xi8, #hls.mem<dram>>, %arg26: index, %arg27: memref<64x28x28xi8, #hls.mem<dram>>, %arg28: memref<64x28x28xi8, #hls.mem<dram>>, %arg29: index):
                  ...
                  ^bb0(%arg30: memref<64x56x56xi8, #hls.mem<dram>>, %arg31: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg32: index, %arg33: index, %arg34: index):
                    affine.for %arg35 = 0 to 16 {
                      affine.for %arg36 = 0 to 14 {
                        affine.for %arg37 = 0 to 14 {
                          %13 = affine.load %arg30[%arg35 + %arg32 * 16, %arg36 * 2 + %arg33 * 28, %arg37 * 2 + %arg34 * 28] : memref<64x56x56xi8, #hls.mem<dram>>
                  ...
                  ^bb0(%arg30: memref<64x64xi8, #hls.mem<dram>>, %arg31: memref<16x16xi8, #hls.mem<bram_t2p>>, %arg32: index, %arg33: index):
                    affine.for %arg34 = 0 to 16 {
                      affine.for %arg35 = 0 to 16 {
                        %13 = affine.load %arg30[%arg34 + %arg32 * 16, %arg35 + %arg33 * 16] : memref<64x64xi8, #hls.mem<dram>>
                  ...
                  ^bb0(%arg30: memref<64x28x28xi8, #hls.mem<dram>>, %arg31: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg32: index, %arg33: index, %arg34: index):
                    affine.for %arg35 = 0 to 16 {
                      affine.for %arg36 = 0 to 14 {
                        affine.for %arg37 = 0 to 14 {
                          %13 = affine.load %arg30[%arg35 + %arg32 * 16, %arg36 + %arg33 * 14, %arg37 + %arg34 * 14] : memref<64x28x28xi8, #hls.mem<dram>>
                          affine.store %13, %arg31[%arg35, %arg36, %arg37] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                        } {parallel}
                      } {parallel}
                    } {parallel}
                      ...
                      affine.for %arg38 = 0 to 16 {
                        affine.for %arg39 = 0 to 14 {
                          affine.for %arg40 = 0 to 14 {
                            ...
                            affine.if #set(%arg37) {
                              affine.store %15, %arg35[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                            }
                            %16 = affine.load %arg35[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                            %17 = arith.muli %13, %14 : i8
                            %18 = arith.addi %16, %17 : i8
                            affine.store %18, %arg35[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                            %19 = affine.load %arg30[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                            %20 = arith.addi %19, %18 : i8
                            %21 = arith.cmpi ugt, %20, %c-24_i8 : i8
                            %22 = arith.select %21, %20, %c-24_i8 : i8
                            affine.if #set2(%arg37)[%arg36] {
                              affine.store %22, %arg34[%arg38, %arg39, %arg40] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
                            }
                          } {parallel, point}
                        } {parallel, point}
                      } {parallel, point}
                    ...
                    affine.for %arg35 = 0 to 16 {
                      affine.for %arg36 = 0 to 14 {
                        affine.for %arg37 = 0 to 14 {
                          ...
                          affine.store %13, %arg31[%arg35 + %arg32 * 16, %arg36 + %arg33 * 14, %arg37 + %arg34 * 14] : memref<64x28x28xi8, #hls.mem<dram>>
                        } {parallel}
                      } {parallel}
                    } {parallel}
                  }
                  ...
                  affine.for %arg27 = 0 to 16 {
                    affine.for %arg28 = 0 to 14 {
                      affine.for %arg29 = 0 to 14 {
                        %8 = affine.load %arg22[%arg27 + %arg24 * 16, %arg28 + %arg25 * 14, %arg29 + %arg26 * 14] : memref<64x28x28xi8, #hls.mem<dram>>
                  ...
                  affine.for %arg27 = 0 to 14 {
                    affine.for %arg28 = 0 to 14 {
                      affine.for %arg29 = 0 to 16 {
                        ...
                        %9 = affine.load %arg23[%arg29 + %arg24 * 16] : memref<64xi8, #hls.mem<bram_t2p>>
                        %10 = arith.addi %9, %8 : i8
                        %11 = arith.divui %10, %c-24_i8 : i8
                        %12 = hls.affine.select #set3(%arg27, %arg28, %arg25, %arg26) %11, %10 : i8
                        affine.store %12, %arg23[%arg29 + %arg24 * 16] : memref<64xi8, #hls.mem<bram_t2p>>
                      } {parallel, point}
                    } {point}
                  } {point}
                }
            ...
            ^bb0(%arg17: index, %arg18: index, %arg19: memref<64xi8, #hls.mem<bram_t2p>>, %arg20: memref<1000x64xi8, #hls.mem<dram>>, %arg21: memref<1000xi8, #hls.mem<dram>>):
              ...
              ^bb0(%arg22: memref<1000xi8, #hls.mem<dram>>, %arg23: memref<10xi8, #hls.mem<bram_t2p>>, %arg24: index):
                affine.for %arg25 = 0 to 10 {
                  %10 = affine.load %arg22[%arg25 + %arg24 * 10] : memref<1000xi8, #hls.mem<dram>>
              ...
              ^bb0(%arg22: memref<1000x64xi8, #hls.mem<dram>>, %arg23: memref<10x16xi8, #hls.mem<bram_t2p>>, %arg24: index, %arg25: index):
                affine.for %arg26 = 0 to 10 {
                  affine.for %arg27 = 0 to 16 {
                    %10 = affine.load %arg22[%arg26 + %arg24 * 10, %arg27 + %arg25 * 16] : memref<1000x64xi8, #hls.mem<dram>>
              ...
              ^bb0(%arg22: memref<64xi8, #hls.mem<bram_t2p>>, %arg23: memref<10x16xi8, #hls.mem<bram_t2p>>, %arg24: memref<10xi8, #hls.mem<bram_t2p>>, %arg25: memref<10xi8, #hls.mem<bram_t2p>>, %arg26: index):
                ...
                affine.for %arg27 = 0 to 16 {
                  affine.for %arg28 = 0 to 10 {
                    ...
                    affine.if #set(%arg27) {
                      affine.store %10, %arg25[%arg28] : memref<10xi8, #hls.mem<bram_t2p>>
                    }
                    %11 = affine.load %arg25[%arg28] : memref<10xi8, #hls.mem<bram_t2p>>
                    %12 = hls.affine.select #set4(%arg27, %arg26) %c-24_i8, %11 : i8
                    %13 = affine.load %arg22[%arg27 + %arg26 * 16] : memref<64xi8, #hls.mem<bram_t2p>>
                    %14 = affine.load %arg23[%arg28, %arg27] : memref<10x16xi8, #hls.mem<bram_t2p>>
                    %15 = arith.muli %13, %14 : i8
                    %16 = arith.addi %12, %15 : i8
                    affine.store %16, %arg25[%arg28] : memref<10xi8, #hls.mem<bram_t2p>>
                  } {parallel, point}
                } {point}
              }
              ...
              ^bb0(%arg22: memref<10xi8, #hls.mem<bram_t2p>>, %arg23: memref<1000xi8, #hls.mem<dram>>, %arg24: index):
                affine.for %arg25 = 0 to 10 {
                  ...
                  affine.store %10, %arg23[%arg25 + %arg24 * 10] : memref<1000xi8, #hls.mem<dram>>
                } {parallel}
              }
            }
          } {parallel}
