// RUN: scalehls-opt -scalehls-create-dataflow-from-affine %s | FileCheck %s
...
// CHECK:                                 hls.dataflow.dispatch {
// CHECK:                                   %8 = affine.load %7[%arg12, %arg14, %arg15] : memref<16x14x14xi8, 7>
// CHECK:                                   %9 = affine.load %6[%arg13, %arg12] : memref<16x16xi8, 7>
// CHECK:                                   %10 = affine.load %5[%arg13, %arg14, %arg15] : memref<16x14x14xi8, 7>
...
// CHECK:                                   %15 = hls.affine.select #set(%arg7, %arg8, %arg12, %arg6) %14, %12 : i8
// CHECK:                                   affine.store %15, %5[%arg13, %arg14, %arg15] : memref<16x14x14xi8, 7>
// CHECK:                                 }
// CHECK:                               } {parallel, point}
// CHECK:                             } {parallel, point}
// CHECK:                           } {parallel, point}
...
// CHECK:                             affine.for %arg14 = 0 to 14 {
// CHECK:                               hls.dataflow.dispatch {
// CHECK:                                 %8 = affine.load %5[%arg12, %arg13, %arg14] : memref<16x14x14xi8, 7>
...
// CHECK:                                   %11 = arith.muli %8, %9 : i8
// CHECK:                                   %12 = arith.addi %10, %11 : i8
// CHECK:                                   affine.store %12, %5[%arg13, %arg14, %arg15] : memref<16x14x14xi8, 7>
// CHECK:                                 }
// CHECK:                               } {parallel, point}
// CHECK:                             } {parallel, point}
// CHECK:                           } {parallel, point}
...
// CHECK:                             affine.store %10, %9[%arg10, %arg11, %arg12] : memref<16x14x14xi8, 7>
// CHECK:                           }
// CHECK:                         } {parallel}
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
...
// CHECK:                           affine.store %10, %8[%arg10, %arg11] : memref<16x16xi8, 7>
// CHECK:                         }
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
// CHECK:                   }
...
// CHECK:                             affine.store %10, %6[%arg10, %arg11, %arg12] : memref<16x14x14xi8, 7>
// CHECK:                           }
// CHECK:                         } {parallel}
// CHECK:                       } {parallel}
// CHECK:                     } {parallel}
...
// CHECK:                           affine.for %arg13 = 0 to 14 {
// CHECK:                             hls.dataflow.dispatch {
// CHECK:                               %10 = affine.load %9[%arg10, %arg12, %arg13] : memref<16x14x14xi8, 7>
// CHECK:                               %11 = affine.load %8[%arg11, %arg10] : memref<16x16xi8, 7>
...
// CHECK:                               %15 = affine.load %6[%arg11, %arg12, %arg13] : memref<16x14x14xi8, 7>
...
// CHECK:                                 affine.store %18, %5[%arg11, %arg12, %arg13] : memref<16x14x14xi8, 7>
// CHECK:                               }
// CHECK:                             }
// CHECK:                           } {parallel, point}
// CHECK:                         } {parallel, point}
...
// CHECK:                         affine.for %arg12 = 0 to 14 {
// CHECK:                           hls.dataflow.dispatch {
// CHECK:                             %10 = affine.load %5[%arg10, %arg11, %arg12] : memref<16x14x14xi8, 7>
...
// CHECK:                           %10 = hls.affine.select #set2(%arg9, %arg10, %arg6, %arg7) %9, %8 : i8
...
// CHECK:                     affine.store %7, %6[%arg8] : memref<10xi8, 7>
// CHECK:                   }
// CHECK:                 } {parallel}
// CHECK:               }
// CHECK:               hls.dataflow.task {
...
// CHECK:                       affine.store %7, %5[%arg8, %arg9] : memref<10x16xi8, 7>
// CHECK:                     }
// CHECK:                   } {parallel}
// CHECK:                 } {parallel}
// CHECK:               }
...
// CHECK:                     hls.dataflow.dispatch {
// CHECK:                       %7 = affine.load %6[%arg9] : memref<10xi8, 7>
// CHECK:                       %8 = hls.affine.select #set3(%arg8, %arg6) %c-24_i8, %7 : i8
// CHECK:                       %9 = affine.load %4[%arg8 + %arg6 * 16] : memref<64xi8, 7>
// CHECK:                       %10 = affine.load %5[%arg9, %arg8] : memref<10x16xi8, 7>
// CHECK:                       %11 = arith.muli %9, %10 : i8
// CHECK:                       %12 = arith.addi %8, %11 : i8
// CHECK:                       affine.store %12, %6[%arg9] : memref<10xi8, 7>
// CHECK:                     }
// CHECK:                   } {parallel, point}
// CHECK:                 } {point}
// CHECK:               }
...
// CHECK:                 affine.for %arg8 = 0 to 10 {
// CHECK:                   hls.dataflow.dispatch {
// CHECK:                     %7 = affine.load %6[%arg8] : memref<10xi8, 7>
                ...
                affine.for %arg10 = 0 to 2 {
                  affine.for %arg11 = 0 to 2 {
                      ...
                      affine.for %arg13 = 0 to 16 {
                        affine.for %arg14 = 0 to 14 {
                          affine.for %arg15 = 0 to 14 {
                            %8 = affine.load %5[%arg12, %arg14, %arg15] : memref<16x14x14xi8, 7>
                            %9 = affine.load %6[%arg13, %arg12] : memref<16x16xi8, 7>
                            %10 = affine.load %7[%arg13, %arg14, %arg15] : memref<16x14x14xi8, 7>
                            ...
                            affine.store %15, %7[%arg13, %arg14, %arg15] : memref<16x14x14xi8, 7>
                          } {parallel, point}
                        } {parallel, point}
                      } {parallel, point}
                    } {point}
                    affine.for %arg12 = 0 to 16 {
                      affine.for %arg13 = 0 to 14 {
                        affine.for %arg14 = 0 to 14 {
                          %8 = affine.load %7[%arg12, %arg13, %arg14] : memref<16x14x14xi8, 7>
                      ...
                      affine.for %arg13 = 0 to 16 {
                        affine.for %arg14 = 0 to 14 {
                          affine.for %arg15 = 0 to 14 {
                            ...
                            %11 = arith.muli %8, %9 : i8
                            %12 = arith.addi %10, %11 : i8
                            affine.store %12, %7[%arg13, %arg14, %arg15] : memref<16x14x14xi8, 7>
                          } {parallel, point}
                        } {parallel, point}
                      } {parallel, point}
                    } {point}
              ...
              affine.for %arg9 = 0 to 2 {
                ...
                affine.for %arg10 = 0 to 16 {
                  affine.for %arg11 = 0 to 14 {
                    affine.for %arg12 = 0 to 14 {
                      ...
                      affine.store %10, %5[%arg10, %arg11, %arg12] : memref<16x14x14xi8, 7>
                    } {parallel}
                  } {parallel}
                } {parallel}
                %6 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x16xi8, 7>
                affine.for %arg10 = 0 to 16 {
                  affine.for %arg11 = 0 to 16 {
                    ...
                    affine.store %10, %6[%arg10, %arg11] : memref<16x16xi8, 7>
                  } {parallel}
                } {parallel}
                %7 = hls.dataflow.buffer {depth = 1 : i32, init_value = -24 : i8} : memref<16x14x14xi8, 7>
                affine.for %arg10 = 0 to 16 {
                ...
                affine.for %arg10 = 0 to 16 {
                  affine.for %arg11 = 0 to 14 {
                    affine.for %arg12 = 0 to 14 {
                      ...
                      affine.store %10, %8[%arg10, %arg11, %arg12] : memref<16x14x14xi8, 7>
                    } {parallel}
                  } {parallel}
                } {parallel}
                ...
                affine.for %arg10 = 0 to 16 {
                  affine.for %arg11 = 0 to 16 {
                    affine.for %arg12 = 0 to 14 {
                      affine.for %arg13 = 0 to 14 {
                        %10 = affine.load %5[%arg10, %arg12, %arg13] : memref<16x14x14xi8, 7>
                        %11 = affine.load %6[%arg11, %arg10] : memref<16x16xi8, 7>
                        ...
                        %15 = affine.load %8[%arg11, %arg12, %arg13] : memref<16x14x14xi8, 7>
                        %16 = arith.addi %15, %14 : i8
                        %17 = arith.cmpi ugt, %16, %c-24_i8 : i8
                        %18 = arith.select %17, %16, %c-24_i8 : i8
                        affine.if #set1(%arg10, %arg6) {
                          affine.store %18, %9[%arg11, %arg12, %arg13] : memref<16x14x14xi8, 7>
                        }
                      } {parallel, point}
                    } {parallel, point}
                  } {parallel, point}
                ...
                affine.for %arg10 = 0 to 16 {
                  affine.for %arg11 = 0 to 14 {
                    affine.for %arg12 = 0 to 14 {
                      %10 = affine.load %9[%arg10, %arg11, %arg12] : memref<16x14x14xi8, 7>
      ...
      hls.dataflow.task {
        affine.for %arg6 = 0 to 4 {
          affine.for %arg7 = 0 to 100 {
            %5 = hls.dataflow.buffer {depth = 1 : i32} : memref<10xi8, 7>
            affine.for %arg8 = 0 to 10 {
              %7 = affine.load %arg5[%arg8 + %arg7 * 10] : memref<1000xi8, 12>
              affine.store %7, %5[%arg8] : memref<10xi8, 7>
            } {parallel}
            ...
            affine.for %arg8 = 0 to 16 {
              affine.for %arg9 = 0 to 10 {
                %7 = affine.load %5[%arg9] : memref<10xi8, 7>
                %8 = hls.affine.select #set3(%arg8, %arg6) %c-24_i8, %7 : i8
                %9 = affine.load %4[%arg8 + %arg6 * 16] : memref<64xi8, 7>
                %10 = affine.load %6[%arg9, %arg8] : memref<10x16xi8, 7>
                %11 = arith.muli %9, %10 : i8
                %12 = arith.addi %8, %11 : i8
                affine.store %12, %5[%arg9] : memref<10xi8, 7>
              } {parallel, point}
            } {point}
            affine.for %arg8 = 0 to 10 {
              %7 = affine.load %5[%arg8] : memref<10xi8, 7>
