...
// CHECK:               %5 = affine.load %arg0[0, %arg6, %arg7, %arg8] : memref<1x64x56x56xi8, 12>
// CHECK:               %6 = arith.cmpi ugt, %5, %c-24_i8 : i8
// CHECK:               %7 = arith.select %6, %5, %c-24_i8 : i8
// CHECK:               affine.store %7, %arg0[0, %arg6, %arg7, %arg8] : memref<1x64x56x56xi8, 12>
// CHECK:             } {parallel}
// CHECK:           } {parallel}
// CHECK:         } {parallel}
// CHECK:       }
...
// CHECK:                     %8 = affine.load %arg0[0, %arg9, %arg7 * 2 + %arg10 - 1, %arg8 * 2 + %arg11 - 1] : memref<1x64x56x56xi8, 12>
// CHECK:                     %9 = affine.load %arg4[%arg6, %arg9, %arg10, %arg11] : memref<64x64x3x3xi8, 12>
// CHECK:                     %10 = affine.load %0[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:                     %11 = arith.muli %8, %9 : i8
// CHECK:                     %12 = arith.addi %10, %11 : i8
// CHECK:                     affine.store %12, %0[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:                   }
// CHECK:                 }
// CHECK:               }
// CHECK:               %5 = affine.load %0[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:               %6 = arith.cmpi ugt, %5, %c-24_i8 : i8
// CHECK:               %7 = arith.select %6, %5, %c-24_i8 : i8
// CHECK:               affine.store %7, %0[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:             } {parallel}
// CHECK:           } {parallel}
// CHECK:         } {parallel}
// CHECK:       }
...
// CHECK:                 affine.for %arg10 = 0 to 3 {
// CHECK:                   affine.for %arg11 = 0 to 3 {
// CHECK:                     %5 = affine.load %0[0, %arg9, %arg7 + %arg10 - 1, %arg8 + %arg11 - 1] : memref<1x64x28x28xi8, 12>
// CHECK:                     %6 = affine.load %arg3[%arg6, %arg9, %arg10, %arg11] : memref<64x64x3x3xi8, 12>
// CHECK:                     %7 = affine.load %1[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:                     %8 = arith.muli %5, %6 : i8
// CHECK:                     %9 = arith.addi %7, %8 : i8
// CHECK:                     affine.store %9, %1[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:                   }
// CHECK:                 }
// CHECK:               }
// CHECK:             } {parallel}
...
// CHECK:             affine.for %arg8 = 0 to 28 {
// CHECK:               affine.for %arg9 = 0 to 64 {
// CHECK:                 %10 = affine.load %arg0[0, %arg9, %arg7 * 2, %arg8 * 2] : memref<1x64x56x56xi8, 12>
// CHECK:                 %11 = affine.load %arg2[%arg6, %arg9, 0, 0] : memref<64x64x1x1xi8, 12>
// CHECK:                 %12 = affine.load %3[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:                 %13 = arith.muli %10, %11 : i8
// CHECK:                 %14 = arith.addi %12, %13 : i8
// CHECK:                 affine.store %14, %3[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:               }
// CHECK:               %5 = affine.load %1[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:               %6 = affine.load %3[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:               %7 = arith.addi %5, %6 : i8
// CHECK:               %8 = arith.cmpi ugt, %7, %c-24_i8 : i8
// CHECK:               %9 = arith.select %8, %7, %c-24_i8 : i8
// CHECK:               affine.store %9, %2[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:             } {parallel}
// CHECK:           } {parallel}
// CHECK:         } {parallel}
// CHECK:       }
...
// CHECK:           affine.for %arg7 = 0 to 28 {
// CHECK:             affine.for %arg8 = 0 to 28 {
// CHECK:               %7 = affine.load %2[0, %arg6, %arg7, %arg8] : memref<1x64x28x28xi8, 12>
// CHECK:               %8 = affine.load %4[0, %arg6, 0, 0] : memref<1x64x1x1xi8, 7>
// CHECK:               %9 = arith.addi %8, %7 : i8
// CHECK:               affine.store %9, %4[0, %arg6, 0, 0] : memref<1x64x1x1xi8, 7>
// CHECK:             }
// CHECK:           }
// CHECK:           %5 = affine.load %4[0, %arg6, 0, 0] : memref<1x64x1x1xi8, 7>
// CHECK:           %6 = arith.divui %5, %c-24_i8 : i8
// CHECK:           affine.store %6, %4[0, %arg6, 0, 0] : memref<1x64x1x1xi8, 7>
// CHECK:         } {parallel}
// CHECK:       }
// CHECK:       hls.dataflow.task {
// CHECK:         affine.for %arg6 = 0 to 1000 {
// CHECK:           affine.store %c-24_i8, %arg5[0, %arg6] : memref<1x1000xi8, 12>
// CHECK:           affine.for %arg7 = 0 to 64 {
// CHECK:             %5 = affine.load %4[0, %arg7, 0, 0] : memref<1x64x1x1xi8, 7>
// CHECK:             %6 = affine.load %arg1[%arg6, %arg7] : memref<1000x64xi8, 12>
// CHECK:             %7 = affine.load %arg5[0, %arg6] : memref<1x1000xi8, 12>
// CHECK:             %8 = arith.muli %5, %6 : i8
// CHECK:             %9 = arith.addi %7, %8 : i8
// CHECK:             affine.store %9, %arg5[0, %arg6] : memref<1x1000xi8, 12>
// CHECK:           }
// CHECK:         } {parallel}
// CHECK:       }
// CHECK:     }
