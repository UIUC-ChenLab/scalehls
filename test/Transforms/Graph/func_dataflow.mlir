...
module {
  ...
  func @forward(%arg0: tensor<1x3x32x32xi8>) -> tensor<1x10xi8> {
    ...
    // CHECK:   %1 = call @dataflow5(%arg0) : (tensor<1x3x32x32xi8>) -> tensor<1x32x32x64xi8>
    ...
    // CHECK:   %2:2 = call @dataflow4(%1) : (tensor<1x32x32x64xi8>) -> (tensor<1x32x32x64xi8>, tensor<1x32x32x64xi8>)
    ...
    // CHECK:   %3 = call @dataflow3(%2#0, %2#1) : (tensor<1x32x32x64xi8>, tensor<1x32x32x64xi8>) -> tensor<1x32x32x64xi8>
    ...
    // CHECK:   %4 = call @dataflow2(%3) : (tensor<1x32x32x64xi8>) -> tensor<1x1x64xi8>
    ...
    // CHECK:   %5 = call @dataflow1(%4) : (tensor<1x1x64xi8>) -> tensor<1x10xi8>
