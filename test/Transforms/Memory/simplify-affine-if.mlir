...
// CHECK: module {
// CHECK:   func.func @test_syrk(%arg0: f32, %arg1: f32, %arg2: memref<16x16xf32, #hls.mem<bram_t2p>>, %arg3: memref<16x16xf32, #hls.mem<bram_t2p>>) attributes {func_directive = #hls.func<pipeline=false, targetInterval=1, dataflow=false>, top_func} {
...
module  {
  func.func @test_syrk(%arg0: f32, %arg1: f32, %arg2: memref<16x16xf32, #hls.mem<bram_t2p>>, %arg3: memref<16x16xf32, #hls.mem<bram_t2p>>) attributes {func_directive = #hls.func<pipeline=false, targetInterval=1, dataflow=false>, top_func} {
    affine.for %arg4 = 0 to 16 step 2 {
      affine.for %arg5 = 0 to 16 {
        ...
        } {loop_directive = #hls.loop<pipeline=true, targetII=2, dataflow=false, flatten=false>, parallel}
