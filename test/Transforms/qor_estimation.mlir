// RUN: scalehls-opt -qor-estimation="target-spec=%S/config.json dep-analysis=true" %s | FileCheck %s
...
module  {
  // CHECK: attributes {func_directive = #hlscpp.fd<pipeline=false, targetInterval=1, dataflow=false, topFunc=true>, resource = #hlscpp.r<lut=0, dsp=11, bram=0>, timing = #hlscpp.t<0 -> 4119, 4119, 4119>}
