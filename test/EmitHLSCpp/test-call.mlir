...
func.func @callee(%arg0: index, %arg1: memref<16xindex>) -> (index, index, memref<16xindex>, memref<16xindex>) attributes {func_directive = #hls.func<pipeline=false, targetInterval=1, dataflow=false>} {
...
func.func @test_call(%arg0: index, %arg1: memref<16xindex>) -> (index, memref<16xindex>) attributes {func_directive = #hls.func<pipeline=false, targetInterval=1, dataflow=false>, top_func} {
