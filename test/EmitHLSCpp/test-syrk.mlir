...
module  {
  func.func @test_syrk(%arg0: f32, %arg1: f32, %arg2: memref<16x16xf32, #hls.partition<[none, cyclic], [1, 2]>>, %arg3: memref<16x16xf32>) attributes {func_directive = #hls.func<pipeline = false, target_interval = 1, dataflow = false>, top_func} {
      ...
      affine.for %arg5 = 0 to 16 {
        affine.for %arg6 = 0 to 16 {
          affine.if #set0(%arg5, %arg6) {
            ...
            %2 = affine.load %arg2[%arg5, %arg4] : memref<16x16xf32, #hls.partition<[none, cyclic], [1, 2]>>
            %3 = affine.load %arg2[%arg6, %arg4] : memref<16x16xf32, #hls.partition<[none, cyclic], [1, 2]>>
            ...
            %8 = affine.load %arg2[%arg5, %arg4 + 1] : memref<16x16xf32, #hls.partition<[none, cyclic], [1, 2]>>
            %9 = affine.load %arg2[%arg6, %arg4 + 1] : memref<16x16xf32, #hls.partition<[none, cyclic], [1, 2]>>
